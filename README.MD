...
[![Command Line Interface Test](https://github.com/dapalex/py-graphql-mapper/actions/workflows/test-cli.yml/badge.svg)](https://github.com/dapalex/py-graphql-mapper/actions/workflows/test-cli.yml)
