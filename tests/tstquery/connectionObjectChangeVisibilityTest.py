...
"""
    ...
    STEP 2: Call setShow function of the object to set the visibility of field (path to declare with dot notation)
...
def runConnectionObjectVisibility():
...
##
    ...
    logger.info("End of testConnectionObjectVisibility")
