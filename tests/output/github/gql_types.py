...
class NYDXM_ReactionConnection_Field(ReactionConnection):
   """
   NYDXM_ReactionConnection_Field - A list of Reactions left on the Issue.
...
class Reactable(GQLObject):
   ...
   reactions: NYDXM_ReactionConnection_Field
   viewerCanReact: bool
...
class CFXRB_ReactorConnection_Field(ReactorConnection):
   """
   CFXRB_ReactorConnection_Field - Reactors to the reaction subject with the emotion represented by this reaction group.
...
class ReactionGroup(GQLObject):
   ...
   content: ReactionContent
   createdAt: DateTime
   reactors: CFXRB_ReactorConnection_Field
   subject: Reactable
   viewerHasReacted: bool
...
class ELOAP_ReactionConnection_Field(ReactionConnection):
   """
   ELOAP_ReactionConnection_Field - A list of Reactions left on the Issue.
...
class EACXJ_UserContentEditConnection_Field(UserContentEditConnection):
   """
   EACXJ_UserContentEditConnection_Field - A list of edits to this content.
...
class TeamDiscussionComment(GQLObject):
   ...
   reactions: ELOAP_ReactionConnection_Field
   resourcePath: URI
   updatedAt: DateTime
   url: URI
   userContentEdits: EACXJ_UserContentEditConnection_Field
...
class HLPNF_TeamDiscussionCommentConnection_Field(TeamDiscussionCommentConnection):
   """
   HLPNF_TeamDiscussionCommentConnection_Field - A list of comments on this discussion.
...
class VJEBI_ReactionConnection_Field(ReactionConnection):
   """
   VJEBI_ReactionConnection_Field - A list of Reactions left on the Issue.
...
class HKZFP_UserContentEditConnection_Field(UserContentEditConnection):
   """
   HKZFP_UserContentEditConnection_Field - A list of edits to this content.
...
class TeamDiscussion(GQLObject):
   ...
   bodyText: str
   bodyVersion: str
   comments: HLPNF_TeamDiscussionCommentConnection_Field
   ...
   publishedAt: DateTime
   reactionGroups: list_ReactionGroup[ReactionGroup]
   reactions: VJEBI_ReactionConnection_Field
   resourcePath: URI
   team: NewType('Team', GQLObject) ## Circular Reference for Team
   title: str
   updatedAt: DateTime
   url: URI
   userContentEdits: HKZFP_UserContentEditConnection_Field
   viewerCanDelete: bool
   viewerCanPin: bool
   viewerCanReact: bool
...
class SCLVM_UserConnection_Field(UserConnection):
   """
   SCLVM_UserConnection_Field - A list of users to assigned to this draft issue.
...
class STMKG_ProjectV2ItemConnection_Field(Generic[ProjectV2ItemConnection]):
   """
   STMKG_ProjectV2ItemConnection_Field - List of items linked with the draft issue (currently draft issue can be linked to only one item).
...
class DDACB_ProjectV2Connection_Field(ProjectV2Connection):
   """
   DDACB_ProjectV2Connection_Field - Projects that link to this draft issue (currently draft issue can be linked to only one project).
...
class DraftIssue(GQLObject):
   ...
   """
   assignees: SCLVM_UserConnection_Field
   body: str
   bodyHTML: HTML
   bodyText: str
   createdAt: DateTime
   creator: Actor
   id: ID
   projectV2Items: STMKG_ProjectV2ItemConnection_Field ## Circular Reference for ProjectV2ItemConnection
   projectsV2: DDACB_ProjectV2Connection_Field
   title: str
   updatedAt: DateTime
...
class BJSIF_DeploymentStatusConnection_Field(DeploymentStatusConnection):
   """
   BJSIF_DeploymentStatusConnection_Field - A list of statuses associated with the deployment.
...
class Deployment(GQLObject):
   ...
   statuses: BJSIF_DeploymentStatusConnection_Field
   task: str
   updatedAt: DateTime
...
class FFMUD_ReactionConnection_Field(ReactionConnection):
   """
   FFMUD_ReactionConnection_Field - A list of Reactions left on the Issue.
...
class TZKOU_DiscussionCommentConnection_Field(DiscussionCommentConnection):
   """
   TZKOU_DiscussionCommentConnection_Field - The threaded replies to this comment.
...
class IWPTX_UserContentEditConnection_Field(UserContentEditConnection):
   """
   IWPTX_UserContentEditConnection_Field - A list of edits to this content.
...
class DiscussionComment(GQLObject):
   ...
   publishedAt: DateTime
   reactionGroups: list_ReactionGroup[ReactionGroup]
   reactions: FFMUD_ReactionConnection_Field
   replies: TZKOU_DiscussionCommentConnection_Field
   replyTo: NewType('DiscussionComment', GQLObject) ## Circular Reference for DiscussionComment
   resourcePath: URI
   updatedAt: DateTime
   upvoteCount: int
   url: URI
   userContentEdits: IWPTX_UserContentEditConnection_Field
   viewerCanDelete: bool
...
class XGQDR_IssueConnection_Field(IssueConnection):
   """
   XGQDR_IssueConnection_Field - A list of issues associated with this label.
...
class VAQDH_PullRequestConnection_Field(Generic[PullRequestConnection]):
   """
   VAQDH_PullRequestConnection_Field - A list of pull requests associated with this label.
...
class Label(GQLObject):
   ...
   id: ID
   isDefault: bool
   issues: XGQDR_IssueConnection_Field
   name: str
   pullRequests: VAQDH_PullRequestConnection_Field ## Circular Reference for PullRequestConnection
   repository: NewType('Repository', GQLObject) ## Circular Reference for Repository
   resourcePath: URI
   updatedAt: DateTime
   url: URI
...
class FZUVL_DiscussionPollOptionConnection_Field(DiscussionPollOptionConnection):
   """
   FZUVL_DiscussionPollOptionConnection_Field - The options for this poll.
...
class DiscussionPoll(GQLObject):
   ...
   discussion: NewType('Discussion', GQLObject) ## Circular Reference for Discussion
   id: ID
   options: FZUVL_DiscussionPollOptionConnection_Field
   question: str
   totalVoteCount: int
   viewerCanVote: bool
   viewerHasVoted: bool

class OXFPJ_DiscussionCommentConnection_Field(DiscussionCommentConnection):
   """
   OXFPJ_DiscussionCommentConnection_Field - The replies to the discussion.
...
class SIFVJ_LabelConnection_Field(LabelConnection):
   """
   SIFVJ_LabelConnection_Field - A list of labels associated with the object.
...
class BANJM_ReactionConnection_Field(ReactionConnection):
   """
   BANJM_ReactionConnection_Field - A list of Reactions left on the Issue.
...
class CIDES_UserContentEditConnection_Field(UserContentEditConnection):
   """
   CIDES_UserContentEditConnection_Field - A list of edits to this content.
...
class Discussion(GQLObject):
   ...
   comments: OXFPJ_DiscussionCommentConnection_Field
   createdAt: DateTime
   createdViaEmail: bool
   databaseId: int
   editor: Actor
   id: ID
   includesCreatedEdit: bool
   labels: SIFVJ_LabelConnection_Field
   lastEditedAt: DateTime
   locked: bool
   number: int
   poll: DiscussionPoll
   publishedAt: DateTime
   reactionGroups: list_ReactionGroup[ReactionGroup]
   reactions: BANJM_ReactionConnection_Field
   repository: NewType('Repository', GQLObject) ## Circular Reference for Repository
   resourcePath: URI
   title: str
   updatedAt: DateTime
   upvoteCount: int
   url: URI
   userContentEdits: CIDES_UserContentEditConnection_Field
   viewerCanDelete: bool
   viewerCanReact: bool
   viewerCanSubscribe: bool
   viewerCanUpdate: bool
...
class LOPGW_DeploymentReviewerConnection_Field(DeploymentReviewerConnection):
   """
   LOPGW_DeploymentReviewerConnection_Field - The teams or users that can review the deployment
...
class DeploymentProtectionRule(GQLObject):
   ...
   """
   databaseId: int
   reviewers: LOPGW_DeploymentReviewerConnection_Field
   timeout: int
...
class DQJEC_DeploymentProtectionRuleConnection_Field(DeploymentProtectionRuleConnection):
   """
   DQJEC_DeploymentProtectionRuleConnection_Field - The protection rules defined for this environment
...
class Environment(GQLObject):
   ...
   id: ID
   name: str
   protectionRules: DQJEC_DeploymentProtectionRuleConnection_Field
...
class XMTVD_UserConnection_Field(UserConnection):
   """
   XMTVD_UserConnection_Field - A list of users mentioned in the release description
...
class WOJHO_ReactionConnection_Field(ReactionConnection):
   """
   WOJHO_ReactionConnection_Field - A list of Reactions left on the Issue.
...
class ZKXRG_ReleaseAssetConnection_Field(ReleaseAssetConnection):
   """
   ZKXRG_ReleaseAssetConnection_Field - List of releases assets which are dependent on this release.
...
class Release(GQLObject):
   ...
   isLatest: bool
   isPrerelease: bool
   mentions: XMTVD_UserConnection_Field
   name: str
   publishedAt: DateTime
   reactionGroups: list_ReactionGroup[ReactionGroup]
   reactions: WOJHO_ReactionConnection_Field
   releaseAssets: ZKXRG_ReleaseAssetConnection_Field
   repository: NewType('Repository', GQLObject) ## Circular Reference for Repository
   resourcePath: URI
   shortDescriptionHTML: FECCR_HTML_Field
...
class VNQLH_IssueConnection_Field(IssueConnection):
   """
   VNQLH_IssueConnection_Field - A list of issues associated with the milestone.
...
class EDYHI_PullRequestConnection_Field(Generic[PullRequestConnection]):
   """
   EDYHI_PullRequestConnection_Field - A list of pull requests associated with the milestone.
...
class Milestone(GQLObject):
   ...
   dueOn: DateTime
   id: ID
   issues: VNQLH_IssueConnection_Field
   number: int
   progressPercentage: float
   pullRequests: EDYHI_PullRequestConnection_Field ## Circular Reference for PullRequestConnection
   repository: NewType('Repository', GQLObject) ## Circular Reference for Repository
   resourcePath: URI
...
class HALOU_RepositoryConnection_Field(RepositoryConnection):
   """
   HALOU_RepositoryConnection_Field - A list of repositories that the user owns.
...
class JGKGP_Repository_Field(Generic[Repository]):
   """
   JGKGP_Repository_Field - Find Repository.
...
class RepositoryOwner(GQLObject):
   ...
   """
   avatarUrl: PZYRM_URI_Field
   id: ID
   login: str
   repositories: HALOU_RepositoryConnection_Field
   repository: JGKGP_Repository_Field ## Circular Reference for Repository
   resourcePath: URI
   url: URI
...
class OAOZZ_PackageFileConnection_Field(PackageFileConnection):
   """
   OAOZZ_PackageFileConnection_Field - List of files associated with this package version
...
class PackageVersion(GQLObject):
   ...
   """
   files: OAOZZ_PackageFileConnection_Field
   id: ID
...
class IEZQU_PackageVersion_Field(PackageVersion):
   """
   IEZQU_PackageVersion_Field - Find package version by version string.
...
class UPMYE_PackageVersionConnection_Field(PackageVersionConnection):
   """
   UPMYE_PackageVersionConnection_Field - list of versions for this package
...
class Package(GQLObject):
   ...
   version: IEZQU_PackageVersion_Field
   versions: UPMYE_PackageVersionConnection_Field
...
class ACSSV_ProjectCardConnection_Field(ProjectCardConnection):
   """
   ACSSV_ProjectCardConnection_Field - List of cards in the column
...
class ProjectColumn(GQLObject):
   ...
   """
   cards: ACSSV_ProjectCardConnection_Field
   createdAt: DateTime
   databaseId: int
   id: ID
   name: str
...
class OQTFI_Project_Field(Generic[Project]):
   """
   OQTFI_Project_Field - Find project by number.
...
class HYOJR_ProjectConnection_Field(ProjectConnection):
   """
   HYOJR_ProjectConnection_Field - A list of projects under the owner.
...
class ProjectOwner(GQLObject):
   ...
   """
   id: ID
   project: OQTFI_Project_Field ## Circular Reference for Project
   projects: HYOJR_ProjectConnection_Field
   projectsResourcePath: URI
   projectsUrl: URI
   viewerCanCreateProjects: bool

class NVEFH_ProjectColumnConnection_Field(ProjectColumnConnection):
   """
   NVEFH_ProjectColumnConnection_Field - List of columns in the project
...
class XMKFA_ProjectCardConnection_Field(ProjectCardConnection):
   """
   XMKFA_ProjectCardConnection_Field - List of pending cards in this project
...
class Project(GQLObject):
   ...
   closed: bool
   closedAt: DateTime
   columns: NVEFH_ProjectColumnConnection_Field
   createdAt: DateTime
   creator: Actor
   databaseId: int
   id: ID
   ...
   number: int
   owner: ProjectOwner
   pendingCards: XMKFA_ProjectCardConnection_Field
...
class AXLCR_Topic_Field(Generic[Topic]):
   """
   AXLCR_Topic_Field - A list of related topics, including aliases of this topic, sorted with the most relevant
...
class DTIZR_RepositoryConnection_Field(RepositoryConnection):
   """
   DTIZR_RepositoryConnection_Field - A list of repositories.
...
class AAOUR_StargazerConnection_Field(StargazerConnection):
   """
   AAOUR_StargazerConnection_Field - A list of users who have starred this starrable.
...
first. Returns up to 10 Topics.
   ...
   id: ID
   name: str
   relatedTopics: AXLCR_Topic_Field ## Circular Reference for Topic
   repositories: DTIZR_RepositoryConnection_Field
   stargazerCount: int
   stargazers: AAOUR_StargazerConnection_Field
...
class TKROE_CWEConnection_Field(CWEConnection):
   """
   TKROE_CWEConnection_Field - CWEs associated with this Advisory
...
class QMKRU_SecurityVulnerabilityConnection_Field(SecurityVulnerabilityConnection):
   """
   QMKRU_SecurityVulnerabilityConnection_Field - Vulnerabilities associated with this Advisory
...
class SecurityAdvisory(GQLObject):
   ...
   cvss: CVSS
   cwes: TKROE_CWEConnection_Field
   databaseId: int
   description: str
   ghsaId: str
   id: ID
   ...
   summary: str
   updatedAt: DateTime
   vulnerabilities: QMKRU_SecurityVulnerabilityConnection_Field
...
class PQFAL_UserConnection_Field(UserConnection):
   """
   PQFAL_UserConnection_Field - A list of users that can be assigned to issues in this repository.
...
class VMXAR_BranchProtectionRuleConnection_Field(BranchProtectionRuleConnection):
   """
   VMXAR_BranchProtectionRuleConnection_Field - A list of branch protection rules for this repository.
...
class KMUWU_RepositoryCodeowners_Field(RepositoryCodeowners):
   """
   KMUWU_RepositoryCodeowners_Field - Information extracted from the repository's `CODEOWNERS` file.
...
class HPCLK_RepositoryCollaboratorConnection_Field(RepositoryCollaboratorConnection):
   """
   HPCLK_RepositoryCollaboratorConnection_Field - A list of collaborators associated with the repository.
...
class YBWVP_CommitCommentConnection_Field(Generic[CommitCommentConnection]):
   """
   YBWVP_CommitCommentConnection_Field - A list of commit comments associated with the repository.
...
class BXIFT_DeployKeyConnection_Field(DeployKeyConnection):
   """
   BXIFT_DeployKeyConnection_Field - A list of deploy keys that are on this repository.
...
class SZQGA_DeploymentConnection_Field(DeploymentConnection):
   """
   SZQGA_DeploymentConnection_Field - Deployments associated with the repository
...
class SGMPE_Discussion_Field(Discussion):
   """
   SGMPE_Discussion_Field - Returns a single discussion from the current repository by number.
...
class WKUCT_DiscussionCategoryConnection_Field(DiscussionCategoryConnection):
   """
   WKUCT_DiscussionCategoryConnection_Field - A list of discussion categories that are available in the repository.
...
class GKPNI_DiscussionCategory_Field(DiscussionCategory):
   """
   GKPNI_DiscussionCategory_Field - A discussion category by slug.
...
class DZOGQ_DiscussionConnection_Field(DiscussionConnection):
   """
   DZOGQ_DiscussionConnection_Field - A list of discussions that have been opened in the repository.
...
class WIJNR_Environment_Field(Environment):
   """
   WIJNR_Environment_Field - Returns a single active environment from the current repository by name.
...
class RGBWJ_EnvironmentConnection_Field(EnvironmentConnection):
   """
   RGBWJ_EnvironmentConnection_Field - A list of environments that are in this repository.
...
class INAUT_RepositoryConnection_Field(RepositoryConnection):
   """
   INAUT_RepositoryConnection_Field - A list of direct forked repositories.
...
class OWVNK_Issue_Field(Generic[Issue]):
   """
   OWVNK_Issue_Field - Returns a single issue from the current repository by number.
...
class XWKVA_IssueOrPullRequest_Field(IssueOrPullRequest):
   """
   XWKVA_IssueOrPullRequest_Field - Returns a single issue-like object from the current repository by number.
...
class ZQFRX_IssueConnection_Field(IssueConnection):
   """
   ZQFRX_IssueConnection_Field - A list of issues that have been opened in the repository.
...
class QOAHQ_Label_Field(Label):
   """
   QOAHQ_Label_Field - Returns a single label by name
...
class IHEKZ_LabelConnection_Field(LabelConnection):
   """
   IHEKZ_LabelConnection_Field - A list of labels associated with the repository.
...
class BWHNU_LanguageConnection_Field(LanguageConnection):
   """
   BWHNU_LanguageConnection_Field - A list containing a breakdown of the language composition of the repository.
...
class NPOIX_UserConnection_Field(UserConnection):
   """
   NPOIX_UserConnection_Field - A list of Users that can be mentioned in the context of the repository.
...
class VBTYH_Milestone_Field(Milestone):
   """
   VBTYH_Milestone_Field - Returns a single milestone from the current repository by number.
...
class HJNXI_MilestoneConnection_Field(MilestoneConnection):
   """
   HJNXI_MilestoneConnection_Field - A list of milestones associated with the repository.
...
class UDBRI_GitObject_Field(GitObject):
   """
   UDBRI_GitObject_Field - A Git object in the repository
...
class EZSCO_PackageConnection_Field(PackageConnection):
   """
   EZSCO_PackageConnection_Field - A list of packages under the owner.
...
class NPGQQ_PinnedDiscussionConnection_Field(PinnedDiscussionConnection):
   """
   NPGQQ_PinnedDiscussionConnection_Field - A list of discussions that have been pinned in this repository.
...
class ZLGVW_PinnedIssueConnection_Field(PinnedIssueConnection):
   """
   ZLGVW_PinnedIssueConnection_Field - A list of pinned issues for this repository.
...
class HOODQ_Project_Field(Project):
   """
   HOODQ_Project_Field - Find project by number.
...
class WTJUD_ProjectV2_Field(Generic[ProjectV2]):
   """
   WTJUD_ProjectV2_Field - Finds and returns the Project according to the provided Project number.
...
class PLRER_ProjectConnection_Field(ProjectConnection):
   """
   PLRER_ProjectConnection_Field - A list of projects under the owner.
...
class CJTRN_ProjectV2Connection_Field(ProjectV2Connection):
   """
   CJTRN_ProjectV2Connection_Field - List of projects linked to this repository.
...
class UQZKC_PullRequest_Field(Generic[PullRequest]):
   """
   UQZKC_PullRequest_Field - Returns a single pull request from the current repository by number.
...
class SACKF_PullRequestConnection_Field(Generic[PullRequestConnection]):
   """
   SACKF_PullRequestConnection_Field - A list of pull requests that have been opened in the repository.
...
class EEMRI_ProjectV2Connection_Field(ProjectV2Connection):
   """
   EEMRI_ProjectV2Connection_Field - Recent projects that this user has modified in the context of the owner.
...
class UPPFT_Ref_Field(Generic[Ref]):
   """
   UPPFT_Ref_Field - Fetch a given ref from the repository
...
class JHNOB_RefConnection_Field(RefConnection):
   """
   JHNOB_RefConnection_Field - Fetch a list of refs from the repository
...
class MBILQ_Release_Field(Release):
   """
   MBILQ_Release_Field - Lookup a single release given various criteria.
...
class TVIGQ_ReleaseConnection_Field(ReleaseConnection):
   """
   TVIGQ_ReleaseConnection_Field - List of releases which are dependent on this repository.
...
class ETUWU_RepositoryTopicConnection_Field(RepositoryTopicConnection):
   """
   ETUWU_RepositoryTopicConnection_Field - A list of applied repository-topic associations for this repository.
...
class HGOYO_StargazerConnection_Field(StargazerConnection):
   """
   HGOYO_StargazerConnection_Field - A list of users who have starred this starrable.
...
class NJNAA_SubmoduleConnection_Field(SubmoduleConnection):
   """
   NJNAA_SubmoduleConnection_Field - Returns a list of all submodules in this repository parsed from the .gitmodules file as of the default branch's HEAD commit.
...
class DYGSP_RepositoryVulnerabilityAlertConnection_Field(RepositoryVulnerabilityAlertConnection):
   """
   DYGSP_RepositoryVulnerabilityAlertConnection_Field - A list of vulnerability alerts that are on this repository.
...
class WOJBX_UserConnection_Field(UserConnection):
   """
   WOJBX_UserConnection_Field - A list of users watching the repository.
...
class Repository(GQLObject):
   ...
   assignableUsers: PQFAL_UserConnection_Field
   autoMergeAllowed: bool
   branchProtectionRules: VMXAR_BranchProtectionRuleConnection_Field
   codeOfConduct: CodeOfConduct
   codeowners: KMUWU_RepositoryCodeowners_Field
   collaborators: HPCLK_RepositoryCollaboratorConnection_Field
   commitComments: YBWVP_CommitCommentConnection_Field ## Circular Reference for CommitCommentConnection
   ...
   deployKeys: BXIFT_DeployKeyConnection_Field
   deployments: SZQGA_DeploymentConnection_Field
   description: str
   descriptionHTML: HTML
   discussion: SGMPE_Discussion_Field
   discussionCategories: WKUCT_DiscussionCategoryConnection_Field
   discussionCategory: GKPNI_DiscussionCategory_Field
   discussions: DZOGQ_DiscussionConnection_Field
   diskUsage: int
   environment: WIJNR_Environment_Field
   environments: RGBWJ_EnvironmentConnection_Field
   forkCount: int
   forkingAllowed: bool
   forks: INAUT_RepositoryConnection_Field
   ...
   issue: OWVNK_Issue_Field ## Circular Reference for Issue
   issueOrPullRequest: XWKVA_IssueOrPullRequest_Field
   issueTemplates: list_IssueTemplate[IssueTemplate]
   issues: ZQFRX_IssueConnection_Field
   label: QOAHQ_Label_Field
   labels: IHEKZ_LabelConnection_Field
   languages: BWHNU_LanguageConnection_Field
   latestRelease: Release
   licenseInfo: License
   lockReason: RepositoryLockReason
   mentionableUsers: NPOIX_UserConnection_Field
   mergeCommitAllowed: bool
   mergeCommitMessage: MergeCommitMessage
   mergeCommitTitle: MergeCommitTitle
   milestone: VBTYH_Milestone_Field
   milestones: HJNXI_MilestoneConnection_Field
   mirrorUrl: URI
   name: str
   nameWithOwner: str
   object: UDBRI_GitObject_Field
   openGraphImageUrl: URI
   owner: RepositoryOwner
   packages: EZSCO_PackageConnection_Field
   parent: NewType('Repository', GQLObject) ## Circular Reference for Repository
   pinnedDiscussions: NPGQQ_PinnedDiscussionConnection_Field
   pinnedIssues: ZLGVW_PinnedIssueConnection_Field
   primaryLanguage: Language
   project: HOODQ_Project_Field
   projectV2: WTJUD_ProjectV2_Field ## Circular Reference for ProjectV2
   projects: PLRER_ProjectConnection_Field
   projectsResourcePath: URI
   projectsUrl: URI
   projectsV2: CJTRN_ProjectV2Connection_Field
   pullRequest: UQZKC_PullRequest_Field ## Circular Reference for PullRequest
   pullRequestTemplates: list_PullRequestTemplate[PullRequestTemplate]
   pullRequests: SACKF_PullRequestConnection_Field ## Circular Reference for PullRequestConnection
   pushedAt: DateTime
   rebaseMergeAllowed: bool
   recentProjects: EEMRI_ProjectV2Connection_Field
   ref: UPPFT_Ref_Field ## Circular Reference for Ref
   refs: JHNOB_RefConnection_Field
   release: MBILQ_Release_Field
   releases: TVIGQ_ReleaseConnection_Field
   repositoryTopics: ETUWU_RepositoryTopicConnection_Field
   resourcePath: URI
   securityPolicyUrl: URI
   shortDescriptionHTML: QHOFH_HTML_Field
   squashMergeAllowed: bool
   squashMergeCommitMessage: SquashMergeCommitMessage
   squashMergeCommitTitle: SquashMergeCommitTitle
   sshUrl: GitSSHRemote
   stargazerCount: int
   stargazers: HGOYO_StargazerConnection_Field
   submodules: NJNAA_SubmoduleConnection_Field
   tempCloneToken: str
   ...
   viewerSubscription: SubscriptionState
   visibility: RepositoryVisibility
   vulnerabilityAlerts: DYGSP_RepositoryVulnerabilityAlertConnection_Field
   watchers: WOJBX_UserConnection_Field
   webCommitSignoffRequired: bool

class NPYFN_ReactionConnection_Field(ReactionConnection):
   """
   NPYFN_ReactionConnection_Field - A list of Reactions left on the Issue.
...
class OFBBL_UserContentEditConnection_Field(UserContentEditConnection):
   """
   OFBBL_UserContentEditConnection_Field - A list of edits to this content.
...
pull request.
   ...
   pullRequest: NewType('PullRequest', GQLObject) ## Circular Reference for PullRequest
   reactionGroups: list_ReactionGroup[ReactionGroup]
   reactions: NPYFN_ReactionConnection_Field
   repository: Repository
   resourcePath: URI
   updatedAt: DateTime
   url: URI
   userContentEdits: OFBBL_UserContentEditConnection_Field
   viewerCanDelete: bool
   viewerCanMinimize: bool
   viewerCanReact: bool
   viewerCanUpdate: bool
...
class WBVJS_UserConnection_Field(UserConnection):
   """
   WBVJS_UserConnection_Field - A list of Users assigned to this object.
...
class Assignable(GQLObject):
   ...
   """
   assignees: WBVJS_UserConnection_Field
...
class YRSEJ_LabelConnection_Field(LabelConnection):
   """
   YRSEJ_LabelConnection_Field - A list of labels associated with the object.
...
class Labelable(GQLObject):
   ...
   """
   labels: YRSEJ_LabelConnection_Field
...
class VKVUY_UserConnection_Field(UserConnection):
   """
   VKVUY_UserConnection_Field - A list of Users assigned to this object.
...
class ZXQNQ_IssueCommentConnection_Field(IssueCommentConnection):
   """
   ZXQNQ_IssueCommentConnection_Field - A list of comments associated with the Issue.
...
class IOEMF_Hovercard_Field(Hovercard):
   """
   IOEMF_Hovercard_Field - The hovercard information for this issue
...
class ISEZZ_LabelConnection_Field(LabelConnection):
   """
   ISEZZ_LabelConnection_Field - A list of labels associated with the object.
...
class HJOWE_LinkedBranchConnection_Field(LinkedBranchConnection):
   """
   HJOWE_LinkedBranchConnection_Field - Branches linked to this issue.
...
class AKSQW_UserConnection_Field(UserConnection):
   """
   AKSQW_UserConnection_Field - A list of Users that are participating in the Issue conversation.
...
class CFLCL_ProjectCardConnection_Field(ProjectCardConnection):
   """
   CFLCL_ProjectCardConnection_Field - List of project cards associated with this issue.
...
class EHWYA_ProjectV2ItemConnection_Field(Generic[ProjectV2ItemConnection]):
   """
   EHWYA_ProjectV2ItemConnection_Field - List of project items associated with this issue.
...
class XONEM_ProjectV2_Field(Generic[ProjectV2]):
   """
   XONEM_ProjectV2_Field - Find a project by number.
...
class KUFCW_ProjectV2Connection_Field(ProjectV2Connection):
   """
   KUFCW_ProjectV2Connection_Field - A list of projects under the owner.
...
class BURXI_ReactionConnection_Field(ReactionConnection):
   """
   BURXI_ReactionConnection_Field - A list of Reactions left on the Issue.
...
class THSUU_IssueTimelineItemsConnection_Field(IssueTimelineItemsConnection):
   """
   THSUU_IssueTimelineItemsConnection_Field - A list of events, comments, commits, etc. associated with the issue.
...
class RARQM_IssueConnection_Field(IssueConnection):
   """
   RARQM_IssueConnection_Field - A list of issues that track this issue
...
class MGXVE_IssueConnection_Field(IssueConnection):
   """
   MGXVE_IssueConnection_Field - A list of issues tracked inside the current issue
...
class JWRCP_UserContentEditConnection_Field(UserContentEditConnection):
   """
   JWRCP_UserContentEditConnection_Field - A list of edits to this content.
...
class Issue(GQLObject):
   ...
   """
   activeLockReason: LockReason
   assignees: VKVUY_UserConnection_Field
   author: Actor
   authorAssociation: CommentAuthorAssociation
   body: str
   bodyHTML: HTML
   ...
   closed: bool
   closedAt: DateTime
   comments: ZXQNQ_IssueCommentConnection_Field
   createdAt: DateTime
   createdViaEmail: bool
   databaseId: int
   editor: Actor
   hovercard: IOEMF_Hovercard_Field
   id: ID
   includesCreatedEdit: bool
   isPinned: bool
   isReadByViewer: bool
   labels: ISEZZ_LabelConnection_Field
   lastEditedAt: DateTime
   linkedBranches: HJOWE_LinkedBranchConnection_Field
   locked: bool
   milestone: Milestone
   number: int
   participants: AKSQW_UserConnection_Field
   projectCards: CFLCL_ProjectCardConnection_Field
   projectItems: EHWYA_ProjectV2ItemConnection_Field ## Circular Reference for ProjectV2ItemConnection
   projectV2: XONEM_ProjectV2_Field ## Circular Reference for ProjectV2
   projectsV2: KUFCW_ProjectV2Connection_Field
   publishedAt: DateTime
   reactionGroups: list_ReactionGroup[ReactionGroup]
   reactions: BURXI_ReactionConnection_Field
   repository: Repository
   resourcePath: URI
   state: IssueState
   stateReason: IssueStateReason
   timelineItems: THSUU_IssueTimelineItemsConnection_Field
   title: str
   titleHTML: str
   trackedInIssues: RARQM_IssueConnection_Field
   trackedIssues: MGXVE_IssueConnection_Field
   trackedIssuesCount: ADVTC_trackedIssuesCount_Field
   updatedAt: DateTime
   url: URI
   userContentEdits: JWRCP_UserContentEditConnection_Field
   viewerCanReact: bool
   viewerCanSubscribe: bool
   viewerCanUpdate: bool
   viewerCannotUpdateReasons: CommentCannotUpdateReason
...
class EIAIC_LabelConnection_Field(LabelConnection):
   """
   EIAIC_LabelConnection_Field - Labels value of a field
...
class ProjectV2ItemFieldLabelValue(GQLObject):
   ...
   """
   field: ProjectV2FieldConfiguration
   labels: EIAIC_LabelConnection_Field
...
class RGCBP_PullRequestConnection_Field(Generic[PullRequestConnection]):
   """
   RGCBP_PullRequestConnection_Field - The pull requests for this field
...
class ProjectV2ItemFieldPullRequestValue(GQLObject):
   ...
   """
   field: ProjectV2FieldConfiguration
   pullRequests: RGCBP_PullRequestConnection_Field ## Circular Reference for PullRequestConnection
...
class EPCJW_RequestedReviewerConnection_Field(RequestedReviewerConnection):
   """
   EPCJW_RequestedReviewerConnection_Field - The reviewers for this field.
...
class ProjectV2ItemFieldReviewerValue(GQLObject):
   ...
   """
   field: ProjectV2FieldConfiguration
   reviewers: EPCJW_RequestedReviewerConnection_Field
...
class OYYGI_UserConnection_Field(UserConnection):
   """
   OYYGI_UserConnection_Field - The users for this field
...
class ProjectV2ItemFieldUserValue(GQLObject):
   ...
   """
   field: ProjectV2FieldConfiguration
   users: OYYGI_UserConnection_Field
...
class WJVAW_ProjectV2ItemFieldValue_Field(ProjectV2ItemFieldValue):
   """
   WJVAW_ProjectV2ItemFieldValue_Field - A specific field value given a field name
...
class CILRM_ProjectV2ItemFieldValueConnection_Field(ProjectV2ItemFieldValueConnection):
   """
   CILRM_ProjectV2ItemFieldValueConnection_Field - List of field values
...
class ProjectV2Item(GQLObject):
   ...
   creator: Actor
   databaseId: int
   fieldValueByName: WJVAW_ProjectV2ItemFieldValue_Field
   fieldValues: CILRM_ProjectV2ItemFieldValueConnection_Field
   id: ID
   isArchived: bool
   project: NewType('ProjectV2', GQLObject) ## Circular Reference for ProjectV2
...
class SEWXA_ProjectV2_Field(Generic[ProjectV2]):
   """
   SEWXA_ProjectV2_Field - Find a project by number.
...
class PKIVR_ProjectV2Connection_Field(ProjectV2Connection):
   """
   PKIVR_ProjectV2Connection_Field - A list of projects under the owner.
...
class ProjectV2Owner(GQLObject):
   ...
   """
   id: ID
   projectV2: SEWXA_ProjectV2_Field ## Circular Reference for ProjectV2
   projectsV2: PKIVR_ProjectV2Connection_Field
...
class PCPOA_ProjectV2FieldConfigurationConnection_Field(ProjectV2FieldConfigurationConnection):
   """
   PCPOA_ProjectV2FieldConfigurationConnection_Field - The view's visible fields.
...
class PBQRH_ProjectV2FieldConfigurationConnection_Field(ProjectV2FieldConfigurationConnection):
   """
   PBQRH_ProjectV2FieldConfigurationConnection_Field - The view's group-by field.
...
class LKMIM_ProjectV2SortByFieldConnection_Field(ProjectV2SortByFieldConnection):
   """
   LKMIM_ProjectV2SortByFieldConnection_Field - The view's sort-by config.
...
class ZNUYY_ProjectV2FieldConfigurationConnection_Field(ProjectV2FieldConfigurationConnection):
   """
   ZNUYY_ProjectV2FieldConfigurationConnection_Field - The view's vertical-group-by field.
...
class ProjectV2View(GQLObject):
   ...
   createdAt: DateTime
   databaseId: int
   fields: PCPOA_ProjectV2FieldConfigurationConnection_Field
   filter: str
   groupByFields: PBQRH_ProjectV2FieldConfigurationConnection_Field
   id: ID
   layout: ProjectV2ViewLayout
   name: str
   number: int
   project: NewType('ProjectV2', GQLObject) ## Circular Reference for ProjectV2
   sortByFields: LKMIM_ProjectV2SortByFieldConnection_Field
   updatedAt: DateTime
   verticalGroupByFields: ZNUYY_ProjectV2FieldConfigurationConnection_Field
...
class WPYCF_ProjectV2FieldConfiguration_Field(ProjectV2FieldConfiguration):
   """
   WPYCF_ProjectV2FieldConfiguration_Field - A field of the project
...
class RJKSW_ProjectV2FieldConfigurationConnection_Field(ProjectV2FieldConfigurationConnection):
   """
   RJKSW_ProjectV2FieldConfigurationConnection_Field - List of fields and their constraints in the project
...
class WBODT_ProjectV2ItemConnection_Field(ProjectV2ItemConnection):
   """
   WBODT_ProjectV2ItemConnection_Field - List of items in the project
...
class JZVTX_RepositoryConnection_Field(RepositoryConnection):
   """
   JZVTX_RepositoryConnection_Field - The repositories the project is linked to.
...
class IYCZB_TeamConnection_Field(TeamConnection):
   """
   IYCZB_TeamConnection_Field - The teams the project is linked to.
...
class IJEEX_ProjectV2View_Field(ProjectV2View):
   """
   IJEEX_ProjectV2View_Field - A view of the project
...
class VAZCX_ProjectV2ViewConnection_Field(ProjectV2ViewConnection):
   """
   VAZCX_ProjectV2ViewConnection_Field - List of views in the project
...
class ProjectV2(GQLObject):
   ...
   creator: Actor
   databaseId: int
   field: WPYCF_ProjectV2FieldConfiguration_Field
   fields: RJKSW_ProjectV2FieldConfigurationConnection_Field
   id: ID
   items: WBODT_ProjectV2ItemConnection_Field
   number: int
   owner: ProjectV2Owner
   public: bool
   readme: str
   repositories: JZVTX_RepositoryConnection_Field
   resourcePath: URI
   shortDescription: str
   teams: IYCZB_TeamConnection_Field
   title: str
   updatedAt: DateTime
   url: URI
   view: IJEEX_ProjectV2View_Field
   viewerCanUpdate: bool
   views: VAZCX_ProjectV2ViewConnection_Field
...
class EVRZN_TeamConnection_Field(TeamConnection):
   """
   EVRZN_TeamConnection_Field - A list of teams that are ancestors of this team.
...
class TIXTK_TeamConnection_Field(TeamConnection):
   """
   TIXTK_TeamConnection_Field - List of child teams belonging to this team
...
class FTFKA_TeamDiscussion_Field(TeamDiscussion):
   """
   FTFKA_TeamDiscussion_Field - Find a team discussion by its number.
...
class JTGOL_TeamDiscussionConnection_Field(TeamDiscussionConnection):
   """
   JTGOL_TeamDiscussionConnection_Field - A list of team discussions.
...
class QWNZL_OrganizationInvitationConnection_Field(OrganizationInvitationConnection):
   """
   QWNZL_OrganizationInvitationConnection_Field - A list of pending invitations for users to this team
...
class IQAOE_UserStatusConnection_Field(UserStatusConnection):
   """
   IQAOE_UserStatusConnection_Field - Get the status messages members of this entity have set that are either public or visible only to the organization.
...
class MSBIA_TeamMemberConnection_Field(TeamMemberConnection):
   """
   MSBIA_TeamMemberConnection_Field - A list of users who are members of this team.
...
class BDBWC_ProjectV2_Field(ProjectV2):
   """
   BDBWC_ProjectV2_Field - Finds and returns the project according to the provided project number.
...
class AOADN_ProjectV2Connection_Field(ProjectV2Connection):
   """
   AOADN_ProjectV2Connection_Field - List of projects this team has collaborator access to.
...
class UFYFR_TeamRepositoryConnection_Field(TeamRepositoryConnection):
   """
   UFYFR_TeamRepositoryConnection_Field - A list of repositories this team has access to.
...
class Team(GQLObject):
   ...
   """
   ancestors: EVRZN_TeamConnection_Field
   avatarUrl: FRTRH_URI_Field
   childTeams: TIXTK_TeamConnection_Field
   combinedSlug: str
   createdAt: DateTime
   databaseId: int
   description: str
   discussion: FTFKA_TeamDiscussion_Field
   discussions: JTGOL_TeamDiscussionConnection_Field
   discussionsResourcePath: URI
   discussionsUrl: URI
   editTeamResourcePath: URI
   editTeamUrl: URI
   id: ID
   invitations: QWNZL_OrganizationInvitationConnection_Field
   memberStatuses: IQAOE_UserStatusConnection_Field
   members: MSBIA_TeamMemberConnection_Field
   ...
   privacy: TeamPrivacy
   projectV2: BDBWC_ProjectV2_Field
   projectsV2: AOADN_ProjectV2Connection_Field
   repositories: UFYFR_TeamRepositoryConnection_Field
...
class HHUFE_BranchProtectionRuleConflictConnection_Field(BranchProtectionRuleConflictConnection):
   """
   HHUFE_BranchProtectionRuleConflictConnection_Field - A list of conflicts matching branches protection rule and other branch protection rules
...
class VGLBY_BypassForcePushAllowanceConnection_Field(BypassForcePushAllowanceConnection):
   """
   VGLBY_BypassForcePushAllowanceConnection_Field - A list of actors able to force push for this branch protection rule.
...
class NCWNH_BypassPullRequestAllowanceConnection_Field(BypassPullRequestAllowanceConnection):
   """
   NCWNH_BypassPullRequestAllowanceConnection_Field - A list of actors able to bypass PRs for this branch protection rule.
...
class ZUPPH_RefConnection_Field(RefConnection):
   """
   ZUPPH_RefConnection_Field - Repository refs that are protected by this rule
...
class CNZWC_PushAllowanceConnection_Field(PushAllowanceConnection):
   """
   CNZWC_PushAllowanceConnection_Field - A list push allowances for this branch protection rule.
...
class DZXNU_ReviewDismissalAllowanceConnection_Field(ReviewDismissalAllowanceConnection):
   """
   DZXNU_ReviewDismissalAllowanceConnection_Field - A list review dismissal allowances for this branch protection rule.
...
class BranchProtectionRule(GQLObject):
   ...
   allowsForcePushes: bool
   blocksCreations: bool
   branchProtectionRuleConflicts: HHUFE_BranchProtectionRuleConflictConnection_Field
   bypassForcePushAllowances: VGLBY_BypassForcePushAllowanceConnection_Field
   bypassPullRequestAllowances: NCWNH_BypassPullRequestAllowanceConnection_Field
   creator: Actor
   databaseId: int
   ...
   lockBranch: bool
   matchingRefs: ZUPPH_RefConnection_Field
   pattern: str
   pushAllowances: CNZWC_PushAllowanceConnection_Field
   repository: Repository
   ...
   reviewDismissalAllowances: DZXNU_ReviewDismissalAllowanceConnection_Field
...
class HJQOQ_ComparisonCommitConnection_Field(ComparisonCommitConnection):
   """
   HJQOQ_ComparisonCommitConnection_Field - The commits which compose this comparison.
...
class Comparison(GQLObject):
   ...
   behindBy: int
   commits: HJQOQ_ComparisonCommitConnection_Field
   headTarget: GitObject
   id: ID
   status: ComparisonStatus

class QFLBF_PullRequestConnection_Field(Generic[PullRequestConnection]):
   """
   QFLBF_PullRequestConnection_Field - A list of pull requests with this ref as the head ref.
...
class LYPUW_Comparison_Field(Comparison):
   """
   LYPUW_Comparison_Field - Compares the current ref as a base ref to another head ref, if the comparison can be made.
...
class Ref(GQLObject):
   ...
   """
   associatedPullRequests: QFLBF_PullRequestConnection_Field ## Circular Reference for PullRequestConnection
   branchProtectionRule: BranchProtectionRule
   compare: LYPUW_Comparison_Field
   id: ID
   name: str
   prefix: str
...
class FREWH_ReactionConnection_Field(ReactionConnection):
   """
   FREWH_ReactionConnection_Field - A list of Reactions left on the Issue.
...
class HWOQD_UserContentEditConnection_Field(UserContentEditConnection):
   """
   HWOQD_UserContentEditConnection_Field - A list of edits to this content.
...
class PullRequestReviewComment(GQLObject):
   ...
   reactionGroups: list_ReactionGroup[ReactionGroup]
   reactions: FREWH_ReactionConnection_Field
   ...
   updatedAt: DateTime
   url: URI
   userContentEdits: HWOQD_UserContentEditConnection_Field
   viewerCanDelete: bool
   viewerCanMinimize: bool
   viewerCanReact: bool
   viewerCanUpdate: bool
...
class GANQZ_PullRequestReviewCommentConnection_Field(PullRequestReviewCommentConnection):
   """
   GANQZ_PullRequestReviewCommentConnection_Field - A list of review comments for the current pull request review.
...
class HSONN_TeamConnection_Field(TeamConnection):
   """
   HSONN_TeamConnection_Field - A list of teams that this review was made on behalf of.
...
class QAGJL_ReactionConnection_Field(ReactionConnection):
   """
   QAGJL_ReactionConnection_Field - A list of Reactions left on the Issue.
...
class LYRPD_UserContentEditConnection_Field(UserContentEditConnection):
   """
   LYRPD_UserContentEditConnection_Field - A list of edits to this content.
...
class PullRequestReview(GQLObject):
   ...
   bodyHTML: HTML
   bodyText: str
   comments: GANQZ_PullRequestReviewCommentConnection_Field
   commit: NewType('Commit', GQLObject) ## Circular Reference for Commit
   createdAt: DateTime
   createdViaEmail: bool
   databaseId: int
   ...
   includesCreatedEdit: bool
   lastEditedAt: DateTime
   onBehalfOf: HSONN_TeamConnection_Field
   publishedAt: DateTime
   pullRequest: NewType('PullRequest', GQLObject) ## Circular Reference for PullRequest
   reactionGroups: list_ReactionGroup[ReactionGroup]
   reactions: QAGJL_ReactionConnection_Field
   repository: Repository
   resourcePath: URI
   ...
   updatedAt: DateTime
   url: URI
   userContentEdits: LYRPD_UserContentEditConnection_Field
   viewerCanDelete: bool
   viewerCanReact: bool
   viewerCanUpdate: bool
   viewerCannotUpdateReasons: CommentCannotUpdateReason
...
class ZOKQD_PullRequestReviewCommentConnection_Field(PullRequestReviewCommentConnection):
   """
   ZOKQD_PullRequestReviewCommentConnection_Field - A list of pull request comments associated with the thread.
...
class PullRequestReviewThread(GQLObject):
   ...
   """
   comments: ZOKQD_PullRequestReviewCommentConnection_Field
   diffSide: DiffSide
   id: ID
   isCollapsed: bool
   isOutdated: bool
...
class ERCWO_CommitCommentConnection_Field(Generic[CommitCommentConnection]):
   """
   ERCWO_CommitCommentConnection_Field - The comments that exist in this thread.
...
class CommitCommentThread(GQLObject):
   ...
   """
   comments: ERCWO_CommitCommentConnection_Field ## Circular Reference for CommitCommentConnection
   commit: NewType('Commit', GQLObject) ## Circular Reference for Commit
   id: ID
   path: str
   position: int
...
class VNGFN_CommitCommentConnection_Field(Generic[CommitCommentConnection]):
   """
   VNGFN_CommitCommentConnection_Field - The comments that exist in this thread.
...
class PullRequestCommitCommentThread(GQLObject):
   ...
   """
   comments: VNGFN_CommitCommentConnection_Field ## Circular Reference for CommitCommentConnection
   commit: NewType('Commit', GQLObject) ## Circular Reference for Commit
   id: ID
   path: str
   position: int
...
class NRZZS_UserConnection_Field(UserConnection):
   """
   NRZZS_UserConnection_Field - A list of Users assigned to this object.
...
class LVKMT_IssueConnection_Field(IssueConnection):
   """
   LVKMT_IssueConnection_Field - List of issues that were may be closed by this pull request
...
class GAOCO_IssueCommentConnection_Field(IssueCommentConnection):
   """
   GAOCO_IssueCommentConnection_Field - A list of comments associated with the pull request.
...
class GOXEZ_PullRequestCommitConnection_Field(PullRequestCommitConnection):
   """
   GOXEZ_PullRequestCommitConnection_Field - A list of commits present in this pull request's head branch not present in the base branch.
...
class VRBTB_PullRequestChangedFileConnection_Field(PullRequestChangedFileConnection):
   """
   VRBTB_PullRequestChangedFileConnection_Field - Lists the files changed within this pull request.
...
class LVUZF_Hovercard_Field(Hovercard):
   """
   LVUZF_Hovercard_Field - The hovercard information for this issue
...
class SMGNT_LabelConnection_Field(LabelConnection):
   """
   SMGNT_LabelConnection_Field - A list of labels associated with the object.
...
class HIIDL_PullRequestReviewConnection_Field(PullRequestReviewConnection):
   """
   HIIDL_PullRequestReviewConnection_Field - A list of latest reviews per user associated with the pull request.
...
class MKEIU_PullRequestReviewConnection_Field(PullRequestReviewConnection):
   """
   MKEIU_PullRequestReviewConnection_Field - A list of latest reviews per user associated with the pull request that are not also pending review.
...
class GJJST_UserConnection_Field(UserConnection):
   """
   GJJST_UserConnection_Field - A list of Users that are participating in the Pull Request conversation.
...
class EFDWF_ProjectCardConnection_Field(ProjectCardConnection):
   """
   EFDWF_ProjectCardConnection_Field - List of project cards associated with this pull request.
...
class BQRSF_ProjectV2ItemConnection_Field(ProjectV2ItemConnection):
   """
   BQRSF_ProjectV2ItemConnection_Field - List of project items associated with this pull request.
...
class LOWGX_ProjectV2_Field(ProjectV2):
   """
   LOWGX_ProjectV2_Field - Find a project by number.
...
class XXRLO_ProjectV2Connection_Field(ProjectV2Connection):
   """
   XXRLO_ProjectV2Connection_Field - A list of projects under the owner.
...
class LZOCR_ReactionConnection_Field(ReactionConnection):
   """
   LZOCR_ReactionConnection_Field - A list of Reactions left on the Issue.
...
class YEFSM_ReviewRequestConnection_Field(ReviewRequestConnection):
   """
   YEFSM_ReviewRequestConnection_Field - A list of review requests associated with the pull request.
...
class YPTKU_PullRequestReviewThreadConnection_Field(PullRequestReviewThreadConnection):
   """
   YPTKU_PullRequestReviewThreadConnection_Field - The list of all review threads for this pull request.
...
class WZNRM_PullRequestReviewConnection_Field(PullRequestReviewConnection):
   """
   WZNRM_PullRequestReviewConnection_Field - A list of reviews associated with the pull request.
...
class DHLFS_PullRequestTimelineItemsConnection_Field(PullRequestTimelineItemsConnection):
   """
   DHLFS_PullRequestTimelineItemsConnection_Field - A list of events, comments, commits, etc. associated with the pull request.
...
class GMWOP_UserContentEditConnection_Field(UserContentEditConnection):
   """
   GMWOP_UserContentEditConnection_Field - A list of edits to this content.
...
class PullRequest(GQLObject):
   ...
   activeLockReason: LockReason
   additions: int
   assignees: NRZZS_UserConnection_Field
   author: Actor
   authorAssociation: CommentAuthorAssociation
   ...
   closed: bool
   closedAt: DateTime
   closingIssuesReferences: LVKMT_IssueConnection_Field
   comments: GAOCO_IssueCommentConnection_Field
   commits: GOXEZ_PullRequestCommitConnection_Field
   createdAt: DateTime
   createdViaEmail: bool
   databaseId: int
   deletions: int
   editor: Actor
   files: VRBTB_PullRequestChangedFileConnection_Field
   headRef: Ref
   headRefName: str
   headRefOid: GitObjectID
   headRepository: Repository
   headRepositoryOwner: RepositoryOwner
   hovercard: LVUZF_Hovercard_Field
   id: ID
   includesCreatedEdit: bool
   isCrossRepository: bool
   isDraft: bool
   isReadByViewer: bool
   labels: SMGNT_LabelConnection_Field
   lastEditedAt: DateTime
   latestOpinionatedReviews: HIIDL_PullRequestReviewConnection_Field
   latestReviews: MKEIU_PullRequestReviewConnection_Field
   locked: bool
   maintainerCanModify: bool
   ...
   milestone: Milestone
   number: int
   participants: GJJST_UserConnection_Field
   permalink: URI
   potentialMergeCommit: NewType('Commit', GQLObject) ## Circular Reference for Commit
   projectCards: EFDWF_ProjectCardConnection_Field
   projectItems: BQRSF_ProjectV2ItemConnection_Field
   projectV2: LOWGX_ProjectV2_Field
   projectsV2: XXRLO_ProjectV2Connection_Field
   publishedAt: DateTime
   reactionGroups: list_ReactionGroup[ReactionGroup]
   reactions: LZOCR_ReactionConnection_Field
   repository: Repository
   resourcePath: URI
   revertResourcePath: URI
   revertUrl: URI
   reviewDecision: PullRequestReviewDecision
   reviewRequests: YEFSM_ReviewRequestConnection_Field
   reviewThreads: YPTKU_PullRequestReviewThreadConnection_Field
   reviews: WZNRM_PullRequestReviewConnection_Field
   state: PullRequestState
   suggestedReviewers: SuggestedReviewer
   timelineItems: DHLFS_PullRequestTimelineItemsConnection_Field
   title: str
   titleHTML: HTML
   totalCommentsCount: int
   updatedAt: DateTime
   url: URI
   userContentEdits: GMWOP_UserContentEditConnection_Field
   ...
   viewerMergeBodyText: ACHOO_viewerMergeBodyText_Field
   viewerMergeHeadlineText: IXZOF_viewerMergeHeadlineText_Field
   viewerSubscription: SubscriptionState
...
class MIEJQ_DeploymentReviewerConnection_Field(DeploymentReviewerConnection):
   """
   MIEJQ_DeploymentReviewerConnection_Field - The teams or users that can review the deployment
...
class DeploymentRequest(GQLObject):
   ...
   reviewers: MIEJQ_DeploymentReviewerConnection_Field
   waitTimer: int
...
class VGYNL_CheckAnnotationConnection_Field(CheckAnnotationConnection):
   """
   VGYNL_CheckAnnotationConnection_Field - The check run's annotations
...
class EBGQR_CheckStepConnection_Field(CheckStepConnection):
   """
   EBGQR_CheckStepConnection_Field - The check run's steps
...
class CheckRun(GQLObject):
   ...
   """
   annotations: VGYNL_CheckAnnotationConnection_Field
   ...
   externalId: str
   id: ID
   isRequired: AEGOW_isRequired_Field
   name: str
   ...
   startedAt: DateTime
   status: CheckStatusState
   steps: EBGQR_CheckStepConnection_Field
   summary: str
   text: str
   title: str
   url: URI
...
class StatusContext(GQLObject):
   ...
   description: str
   id: ID
   isRequired: PKCUV_isRequired_Field
   state: StatusState
   targetUrl: URI
...
class YXAQH_StatusCheckRollupContextConnection_Field(StatusCheckRollupContextConnection):
   """
   YXAQH_StatusCheckRollupContextConnection_Field - A list of status contexts and check runs for this commit.
...
class PYVBL_StatusContext_Field(StatusContext):
   """
   PYVBL_StatusContext_Field - Looks up an individual status context by context name.
...
class Status(GQLObject):
   ...
   """
   combinedContexts: YXAQH_StatusCheckRollupContextConnection_Field
   commit: NewType('Commit', GQLObject) ## Circular Reference for Commit
   context: PYVBL_StatusContext_Field
   contexts: StatusContext
   id: ID
   state: StatusState

class EBNIX_StatusCheckRollupContextConnection_Field(StatusCheckRollupContextConnection):
   """
   EBNIX_StatusCheckRollupContextConnection_Field - A list of status contexts and check runs for this commit.
...
class StatusCheckRollup(GQLObject):
   ...
   """
   commit: NewType('Commit', GQLObject) ## Circular Reference for Commit
   contexts: EBNIX_StatusCheckRollupContextConnection_Field
   id: ID
   state: StatusState
...
class YXKIW_PullRequestConnection_Field(PullRequestConnection):
   """
   YXKIW_PullRequestConnection_Field - The merged Pull Request that introduced the commit to the repository. If the commit is not present in the default branch, additionally returns open Pull Requests associated with the commit
...
class OZOOT_GitActorConnection_Field(GitActorConnection):
   """
   OZOOT_GitActorConnection_Field - The list of authors for this commit based on the git author and the Co-authored-by
...
class DPKRH_Blame_Field(Blame):
   """
   DPKRH_Blame_Field - Fetches `git blame` information.
...
class KDQNO_CheckSuiteConnection_Field(CheckSuiteConnection):
   """
   KDQNO_CheckSuiteConnection_Field - The check suites associated with a commit.
...
class NUQWG_CommitCommentConnection_Field(Generic[CommitCommentConnection]):
   """
   NUQWG_CommitCommentConnection_Field - Comments made on the commit.
...
class PQGVV_DeploymentConnection_Field(DeploymentConnection):
   """
   PQGVV_DeploymentConnection_Field - The deployments associated with a commit.
...
class OEMET_TreeEntry_Field(TreeEntry):
   """
   OEMET_TreeEntry_Field - The tree entry representing the file located at the given path.
...
class ZMJNK_CommitHistoryConnection_Field(CommitHistoryConnection):
   """
   ZMJNK_CommitHistoryConnection_Field - The linear commit history starting from (and including) this commit, in the same order as `git log`.
...
class GAJED_CommitConnection_Field(CommitConnection):
   """
   GAJED_CommitConnection_Field - The parents of a commit.
...
class SIYZF_SubmoduleConnection_Field(SubmoduleConnection):
   """
   SIYZF_SubmoduleConnection_Field - Returns a list of all submodules in this repository as of this Commit parsed from the .gitmodules file.
...
Note: For private repositories, these links are temporary and expire after five minutes.
   ...
   abbreviatedOid: str
   additions: int
   associatedPullRequests: YXKIW_PullRequestConnection_Field
   author: GitActor
   authoredByCommitter: bool
   authoredDate: DateTime
   authors: OZOOT_GitActorConnection_Field
   blame: DPKRH_Blame_Field
   changedFilesIfAvailable: int
   checkSuites: KDQNO_CheckSuiteConnection_Field
   comments: NUQWG_CommitCommentConnection_Field ## Circular Reference for CommitCommentConnection
   commitResourcePath: URI
   commitUrl: URI
   ...
   committer: GitActor
   deletions: int
   deployments: PQGVV_DeploymentConnection_Field
   file: OEMET_TreeEntry_Field
   history: ZMJNK_CommitHistoryConnection_Field
   id: ID
   message: str
   messageBody: str
   ...
   parents: GAJED_CommitConnection_Field
   pushedDate: DateTime
   repository: Repository
   resourcePath: URI
   ...
   submodules: SIYZF_SubmoduleConnection_Field
   tarballUrl: URI
   tree: Tree
...
class OWACJ_ReactionConnection_Field(ReactionConnection):
   """
   OWACJ_ReactionConnection_Field - A list of Reactions left on the Issue.
...
class VEUIY_UserContentEditConnection_Field(UserContentEditConnection):
   """
   VEUIY_UserContentEditConnection_Field - A list of edits to this content.
...
class CommitComment(GQLObject):
   ...
   publishedAt: DateTime
   reactionGroups: list_ReactionGroup[ReactionGroup]
   reactions: OWACJ_ReactionConnection_Field
   repository: Repository
   resourcePath: URI
   updatedAt: DateTime
   url: URI
   userContentEdits: VEUIY_UserContentEditConnection_Field
   viewerCanDelete: bool
   viewerCanMinimize: bool
   viewerCanReact: bool
   viewerCanUpdate: bool
...
class HEMNS_CreatedCommitContributionConnection_Field(CreatedCommitContributionConnection):
   """
   HEMNS_CreatedCommitContributionConnection_Field - The commit contributions, each representing a day.
...
class CommitContributionsByRepository(GQLObject):
   ...
   """
   contributions: HEMNS_CreatedCommitContributionConnection_Field
   repository: Repository
   resourcePath: URI
   url: URI
...
class JSKSR_CreatedIssueContributionConnection_Field(CreatedIssueContributionConnection):
   """
   JSKSR_CreatedIssueContributionConnection_Field - The issue contributions.
...
class IssueContributionsByRepository(GQLObject):
   ...
   """
   contributions: JSKSR_CreatedIssueContributionConnection_Field
   repository: Repository
...
class OKUHG_CreatedPullRequestContributionConnection_Field(CreatedPullRequestContributionConnection):
   """
   OKUHG_CreatedPullRequestContributionConnection_Field - The pull request contributions.
...
class PullRequestContributionsByRepository(GQLObject):
   ...
   """
   contributions: OKUHG_CreatedPullRequestContributionConnection_Field
   repository: Repository
...
class AZINV_CreatedPullRequestReviewContributionConnection_Field(CreatedPullRequestReviewContributionConnection):
   """
   AZINV_CreatedPullRequestReviewContributionConnection_Field - The pull request review contributions.
...
class PullRequestReviewContributionsByRepository(GQLObject):
   ...
   """
   contributions: AZINV_CreatedPullRequestReviewContributionConnection_Field
   repository: Repository
...
class KXQSV_CommitContributionsByRepository_Field(CommitContributionsByRepository):
   """
   KXQSV_CommitContributionsByRepository_Field - Commit contributions made by the user, grouped by repository.
...
class PSDPC_CreatedIssueContributionConnection_Field(CreatedIssueContributionConnection):
   """
   PSDPC_CreatedIssueContributionConnection_Field - A list of issues the user opened.
...
class PUWOM_IssueContributionsByRepository_Field(IssueContributionsByRepository):
   """
   PUWOM_IssueContributionsByRepository_Field - Issue contributions made by the user, grouped by repository.
...
class DOJPL_CreatedPullRequestContributionConnection_Field(CreatedPullRequestContributionConnection):
   """
   DOJPL_CreatedPullRequestContributionConnection_Field - Pull request contributions made by the user.
...
class FMHAP_PullRequestContributionsByRepository_Field(PullRequestContributionsByRepository):
   """
   FMHAP_PullRequestContributionsByRepository_Field - Pull request contributions made by the user, grouped by repository.
...
class JZQEA_CreatedPullRequestReviewContributionConnection_Field(CreatedPullRequestReviewContributionConnection):
   """
   JZQEA_CreatedPullRequestReviewContributionConnection_Field - Pull request review contributions made by the user. Returns the most recently
...
class XOFHK_PullRequestReviewContributionsByRepository_Field(PullRequestReviewContributionsByRepository):
   """
   XOFHK_PullRequestReviewContributionsByRepository_Field - Pull request review contributions made by the user, grouped by repository.
...
class SDLDT_CreatedRepositoryContributionConnection_Field(CreatedRepositoryContributionConnection):
   """
   SDLDT_CreatedRepositoryContributionConnection_Field - A list of repositories owned by the user that the user created in this time range.
...
submitted review for each PR reviewed by the user.
   ...
   """
   commitContributionsByRepository: KXQSV_CommitContributionsByRepository_Field
   ...
   isSingleDay: bool
   issueContributions: PSDPC_CreatedIssueContributionConnection_Field
   issueContributionsByRepository: PUWOM_IssueContributionsByRepository_Field
   ...
   pullRequestContributions: DOJPL_CreatedPullRequestContributionConnection_Field
   pullRequestContributionsByRepository: FMHAP_PullRequestContributionsByRepository_Field
   pullRequestReviewContributions: JZQEA_CreatedPullRequestReviewContributionConnection_Field
   pullRequestReviewContributionsByRepository: XOFHK_PullRequestReviewContributionsByRepository_Field
   repositoryContributions: SDLDT_CreatedRepositoryContributionConnection_Field
   restrictedContributionsCount: int
   startedAt: DateTime
   totalCommitContributions: int
   totalIssueContributions: SGTYP_totalIssueContributions_Field
   totalPullRequestContributions: XEEGR_totalPullRequestContributions_Field
   totalPullRequestReviewContributions: int
   totalRepositoriesWithContributedCommits: int
   totalRepositoriesWithContributedIssues: PDWSN_totalRepositoriesWithContributedIssues_Field
   totalRepositoriesWithContributedPullRequestReviews: int
   totalRepositoriesWithContributedPullRequests: QWHHU_totalRepositoriesWithContributedPullRequests_Field
   totalRepositoryContributions: JVPAP_totalRepositoryContributions_Field
   user: NewType('User', GQLObject) ## Circular Reference for User
...
class FWACE_UserContentEditConnection_Field(UserContentEditConnection):
   """
   FWACE_UserContentEditConnection_Field - A list of edits to this content.
...
class GistComment(GQLObject):
   ...
   publishedAt: DateTime
   updatedAt: DateTime
   userContentEdits: FWACE_UserContentEditConnection_Field
   viewerCanDelete: bool
   viewerCanMinimize: bool
   viewerCanUpdate: bool
   viewerCannotUpdateReasons: CommentCannotUpdateReason
...
class GOWWN_GistCommentConnection_Field(GistCommentConnection):
   """
   GOWWN_GistCommentConnection_Field - A list of comments associated with the gist
...
class AQEUQ_GistFile_Field(GistFile):
   """
   AQEUQ_GistFile_Field - The files in this gist.
...
class BUTRC_GistConnection_Field(GistConnection):
   """
   BUTRC_GistConnection_Field - A list of forks associated with the gist
...
class QDGLQ_StargazerConnection_Field(StargazerConnection):
   """
   QDGLQ_StargazerConnection_Field - A list of users who have starred this starrable.
...
class Gist(GQLObject):
   ...
   """
   comments: GOWWN_GistCommentConnection_Field
   createdAt: DateTime
   description: str
   files: AQEUQ_GistFile_Field
   forks: BUTRC_GistConnection_Field
   id: ID
   isFork: bool
   isPublic: bool
   name: str
   ...
   resourcePath: URI
   stargazerCount: int
   stargazers: QDGLQ_StargazerConnection_Field
   updatedAt: DateTime
   url: URI
   viewerHasStarred: bool
...
class GZHOY_PinnableItemConnection_Field(PinnableItemConnection):
   """
   GZHOY_PinnableItemConnection_Field - The repositories and gists in the showcase. If the profile owner has any pinned items, those will be returned. Otherwise, the profile owner's popular repositories will be returned.
...
class ProfileItemShowcase(GQLObject):
   ...
   """
   hasPinnedItems: bool
   items: GZHOY_PinnableItemConnection_Field
...
class SRLYD_SponsorsListingFeaturedItem_Field(SponsorsListingFeaturedItem):
   """
   SRLYD_SponsorsListingFeaturedItem_Field - The records featured on the GitHub Sponsors profile.
...
class HWWZM_SponsorsTierConnection_Field(SponsorsTierConnection):
   """
   HWWZM_SponsorsTierConnection_Field - The tiers for this GitHub Sponsors profile.
...
class SponsorsListing(GQLObject):
   ...
   dashboardUrl: URI
   featuredItems: SRLYD_SponsorsListingFeaturedItem_Field
   ...
   tiers: HWWZM_SponsorsTierConnection_Field
   url: URI
...
class UEGED_SponsorConnection_Field(SponsorConnection):
   """
   UEGED_SponsorConnection_Field - List of users and organizations this entity is sponsoring.
...
class MSDKJ_SponsorConnection_Field(SponsorConnection):
   """
   MSDKJ_SponsorConnection_Field - List of sponsors for this user or organization.
...
class JDKML_SponsorsActivityConnection_Field(Generic[SponsorsActivityConnection]):
   """
   JDKML_SponsorsActivityConnection_Field - Events involving this sponsorable, such as new sponsorships.
...
class SCRMA_Sponsorship_Field(Generic[Sponsorship]):
   """
   SCRMA_Sponsorship_Field - The sponsorship from the viewer to this user/organization; that is, the sponsorship where you're the sponsor.
...
class QAVUO_Sponsorship_Field(Generic[Sponsorship]):
   """
   QAVUO_Sponsorship_Field - The sponsorship from this user/organization to the viewer; that is, the sponsorship you're receiving.
...
class VFKTJ_SponsorshipNewsletterConnection_Field(SponsorshipNewsletterConnection):
   """
   VFKTJ_SponsorshipNewsletterConnection_Field - List of sponsorship updates sent from this sponsorable to sponsors.
...
class ZEZZY_SponsorshipConnection_Field(Generic[SponsorshipConnection]):
   """
   ZEZZY_SponsorshipConnection_Field - The sponsorships where this user or organization is the maintainer receiving the funds.
...
class FYPNN_SponsorshipConnection_Field(Generic[SponsorshipConnection]):
   """
   FYPNN_SponsorshipConnection_Field - The sponsorships where this user or organization is the funder.
...
class Sponsorable(GQLObject):
   ...
   isSponsoredBy: LAPKE_isSponsoredBy_Field
   isSponsoringViewer: bool
   monthlyEstimatedSponsorsIncomeInCents: int
   sponsoring: UEGED_SponsorConnection_Field
   sponsors: MSDKJ_SponsorConnection_Field
   sponsorsActivities: JDKML_SponsorsActivityConnection_Field ## Circular Reference for SponsorsActivityConnection
   sponsorsListing: SponsorsListing
   sponsorshipForViewerAsSponsor: SCRMA_Sponsorship_Field ## Circular Reference for Sponsorship
   sponsorshipForViewerAsSponsorable: QAVUO_Sponsorship_Field ## Circular Reference for Sponsorship
   sponsorshipNewsletters: VFKTJ_SponsorshipNewsletterConnection_Field
   sponsorshipsAsMaintainer: ZEZZY_SponsorshipConnection_Field ## Circular Reference for SponsorshipConnection
   sponsorshipsAsSponsor: FYPNN_SponsorshipConnection_Field ## Circular Reference for SponsorshipConnection
   totalSponsorshipAmountAsSponsorInCents: SAMNF_totalSponsorshipAmountAsSponsorInCents_Field
...
class NIZNO_SponsorshipConnection_Field(SponsorshipConnection):
   """
   NIZNO_SponsorshipConnection_Field - The sponsorships using this tier.
...
class SponsorsTierAdminInfo(GQLObject):
   ...
   isPublished: bool
   isRetired: bool
   sponsorships: NIZNO_SponsorshipConnection_Field
...
class LNNXV_CommitCommentConnection_Field(CommitCommentConnection):
   """
   LNNXV_CommitCommentConnection_Field - A list of commit comments made by this user.
...
class IPMUY_ContributionsCollection_Field(ContributionsCollection):
   """
   IPMUY_ContributionsCollection_Field - The collection of contributions this user has made to different repositories.
...
class OHNUK_FollowerConnection_Field(FollowerConnection):
   """
   OHNUK_FollowerConnection_Field - A list of users the given user is followed by.
...
class MUFWC_FollowingConnection_Field(FollowingConnection):
   """
   MUFWC_FollowingConnection_Field - A list of users the given user is following.
...
class ZCKAK_Gist_Field(Gist):
   """
   ZCKAK_Gist_Field - Find gist by repo name.
...
class BVQWN_GistCommentConnection_Field(GistCommentConnection):
   """
   BVQWN_GistCommentConnection_Field - A list of gist comments made by this user.
...
class ZDWTD_GistConnection_Field(GistConnection):
   """
   ZDWTD_GistConnection_Field - A list of the Gists the user has created.
...
class YOVEE_Hovercard_Field(Hovercard):
   """
   YOVEE_Hovercard_Field - The hovercard information for this user in a given context
...
class WKXLJ_IssueCommentConnection_Field(IssueCommentConnection):
   """
   WKXLJ_IssueCommentConnection_Field - A list of issue comments made by this user.
...
class BVVFD_IssueConnection_Field(IssueConnection):
   """
   BVVFD_IssueConnection_Field - A list of issues associated with this user.
...
class ZETUM_Organization_Field(Generic[Organization]):
   """
   ZETUM_Organization_Field - Find an organization by its login that the user belongs to.
...
class YXCVG_OrganizationConnection_Field(OrganizationConnection):
   """
   YXCVG_OrganizationConnection_Field - A list of organizations the user belongs to.
...
class DATVH_PackageConnection_Field(PackageConnection):
   """
   DATVH_PackageConnection_Field - A list of packages under the owner.
...
class JWLCM_PinnableItemConnection_Field(PinnableItemConnection):
   """
   JWLCM_PinnableItemConnection_Field - A list of repositories and gists this profile owner can pin to their profile.
...
class SDSCS_PinnableItemConnection_Field(PinnableItemConnection):
   """
   SDSCS_PinnableItemConnection_Field - A list of repositories and gists this profile owner has pinned to their profile
...
class BBJQL_Project_Field(Project):
   """
   BBJQL_Project_Field - Find project by number.
...
class RPRAX_ProjectV2_Field(ProjectV2):
   """
   RPRAX_ProjectV2_Field - Find a project by number.
...
class YWDGF_ProjectConnection_Field(ProjectConnection):
   """
   YWDGF_ProjectConnection_Field - A list of projects under the owner.
...
class YTVCX_ProjectV2Connection_Field(ProjectV2Connection):
   """
   YTVCX_ProjectV2Connection_Field - A list of projects under the owner.
...
class LXTWQ_PublicKeyConnection_Field(PublicKeyConnection):
   """
   LXTWQ_PublicKeyConnection_Field - A list of public keys associated with this user.
...
class TCUAB_PullRequestConnection_Field(PullRequestConnection):
   """
   TCUAB_PullRequestConnection_Field - A list of pull requests associated with this user.
...
class ZBUVI_ProjectV2Connection_Field(ProjectV2Connection):
   """
   ZBUVI_ProjectV2Connection_Field - Recent projects that this user has modified in the context of the owner.
...
class SWYPJ_RepositoryConnection_Field(RepositoryConnection):
   """
   SWYPJ_RepositoryConnection_Field - A list of repositories that the user owns.
...
class LYIFN_RepositoryConnection_Field(RepositoryConnection):
   """
   LYIFN_RepositoryConnection_Field - A list of repositories that the user recently contributed to.
...
class YGJLT_Repository_Field(Repository):
   """
   YGJLT_Repository_Field - Find Repository.
...
class VGWKK_DiscussionCommentConnection_Field(DiscussionCommentConnection):
   """
   VGWKK_DiscussionCommentConnection_Field - Discussion comments this user has authored.
...
class UQHKK_DiscussionConnection_Field(DiscussionConnection):
   """
   UQHKK_DiscussionConnection_Field - Discussions this user has started.
...
class QDLQQ_SavedReplyConnection_Field(SavedReplyConnection):
   """
   QDLQQ_SavedReplyConnection_Field - Replies this user has saved
...
class RKWJI_SponsorConnection_Field(SponsorConnection):
   """
   RKWJI_SponsorConnection_Field - List of users and organizations this entity is sponsoring.
...
class YLVKP_SponsorConnection_Field(SponsorConnection):
   """
   YLVKP_SponsorConnection_Field - List of sponsors for this user or organization.
...
class ZCCNC_SponsorsActivityConnection_Field(SponsorsActivityConnection):
   """
   ZCCNC_SponsorsActivityConnection_Field - Events involving this sponsorable, such as new sponsorships.
...
class YWEGN_Sponsorship_Field(Sponsorship):
   """
   YWEGN_Sponsorship_Field - The sponsorship from the viewer to this user/organization; that is, the sponsorship where you're the sponsor.
...
class AKEIU_Sponsorship_Field(Sponsorship):
   """
   AKEIU_Sponsorship_Field - The sponsorship from this user/organization to the viewer; that is, the sponsorship you're receiving.
...
class ARPKT_SponsorshipNewsletterConnection_Field(SponsorshipNewsletterConnection):
   """
   ARPKT_SponsorshipNewsletterConnection_Field - List of sponsorship updates sent from this sponsorable to sponsors.
...
class HMQIK_SponsorshipConnection_Field(SponsorshipConnection):
   """
   HMQIK_SponsorshipConnection_Field - The sponsorships where this user or organization is the maintainer receiving the funds.
...
class JGHIV_SponsorshipConnection_Field(SponsorshipConnection):
   """
   JGHIV_SponsorshipConnection_Field - The sponsorships where this user or organization is the funder.
...
class SLNZH_StarredRepositoryConnection_Field(StarredRepositoryConnection):
   """
   SLNZH_StarredRepositoryConnection_Field - Repositories the user has starred.
...
class UFUHV_RepositoryConnection_Field(RepositoryConnection):
   """
   UFUHV_RepositoryConnection_Field - Repositories the user has contributed to, ordered by contribution rank, plus repositories the user has created
...
class BSSBG_RepositoryConnection_Field(RepositoryConnection):
   """
   BSSBG_RepositoryConnection_Field - A list of repositories the given user is watching.
...
class User(GQLObject):
   ...
   """
   anyPinnableItems: IPLGW_anyPinnableItems_Field
   avatarUrl: RTAOK_URI_Field
   bio: str
   bioHTML: HTML
   canReceiveOrganizationEmailsWhenNotificationsRestricted: JWHUW_canReceiveOrganizationEmailsWhenNotificationsRestricted_Field
   commitComments: LNNXV_CommitCommentConnection_Field
   company: str
   companyHTML: HTML
   contributionsCollection: IPMUY_ContributionsCollection_Field
   createdAt: DateTime
   databaseId: int
   email: str
   estimatedNextSponsorsPayoutInCents: int
   followers: OHNUK_FollowerConnection_Field
   following: MUFWC_FollowingConnection_Field
   gist: ZCKAK_Gist_Field
   gistComments: BVQWN_GistCommentConnection_Field
   gists: ZDWTD_GistConnection_Field
   hasSponsorsListing: bool
   hovercard: YOVEE_Hovercard_Field
   id: ID
   interactionAbility: RepositoryInteractionAbility
   isBountyHunter: bool
   isCampusExpert: bool
   ...
   isHireable: bool
   isSiteAdmin: bool
   isSponsoredBy: VKERH_isSponsoredBy_Field
   isSponsoringViewer: bool
   isViewer: bool
   issueComments: WKXLJ_IssueCommentConnection_Field
   issues: BVVFD_IssueConnection_Field
   itemShowcase: ProfileItemShowcase
   location: str
   login: str
   monthlyEstimatedSponsorsIncomeInCents: int
   name: str
   organization: ZETUM_Organization_Field ## Circular Reference for Organization
   organizationVerifiedDomainEmails: FOGWM_organizationVerifiedDomainEmails_Field
   organizations: YXCVG_OrganizationConnection_Field
   packages: DATVH_PackageConnection_Field
   pinnableItems: JWLCM_PinnableItemConnection_Field
   pinnedItems: SDSCS_PinnableItemConnection_Field
   pinnedItemsRemaining: int
   project: BBJQL_Project_Field
   projectV2: RPRAX_ProjectV2_Field
   projects: YWDGF_ProjectConnection_Field
   projectsResourcePath: URI
   projectsUrl: URI
   projectsV2: YTVCX_ProjectV2Connection_Field
   publicKeys: LXTWQ_PublicKeyConnection_Field
   pullRequests: TCUAB_PullRequestConnection_Field
   recentProjects: ZBUVI_ProjectV2Connection_Field
   repositories: SWYPJ_RepositoryConnection_Field
   repositoriesContributedTo: LYIFN_RepositoryConnection_Field
   repository: YGJLT_Repository_Field
   repositoryDiscussionComments: VGWKK_DiscussionCommentConnection_Field
   repositoryDiscussions: UQHKK_DiscussionConnection_Field
   resourcePath: URI
   savedReplies: QDLQQ_SavedReplyConnection_Field
   sponsoring: RKWJI_SponsorConnection_Field
   sponsors: YLVKP_SponsorConnection_Field
   sponsorsActivities: ZCCNC_SponsorsActivityConnection_Field
   sponsorsListing: SponsorsListing
   sponsorshipForViewerAsSponsor: YWEGN_Sponsorship_Field
   sponsorshipForViewerAsSponsorable: AKEIU_Sponsorship_Field
   sponsorshipNewsletters: ARPKT_SponsorshipNewsletterConnection_Field
   sponsorshipsAsMaintainer: HMQIK_SponsorshipConnection_Field
   sponsorshipsAsSponsor: JGHIV_SponsorshipConnection_Field
   starredRepositories: SLNZH_StarredRepositoryConnection_Field
   status: UserStatus
   topRepositories: UFUHV_RepositoryConnection_Field
   totalSponsorshipAmountAsSponsorInCents: IHBCR_totalSponsorshipAmountAsSponsorInCents_Field
   twitterUsername: str
   updatedAt: DateTime
   url: URI
   ...
   viewerIsSponsoring: bool
   watching: BSSBG_RepositoryConnection_Field
   websiteUrl: URI
...
class RGXAY_ExternalIdentityConnection_Field(ExternalIdentityConnection):
   """
   RGXAY_ExternalIdentityConnection_Field - External Identities provisioned by this Identity Provider
...
class OrganizationIdentityProvider(GQLObject):
   ...
   """
   digestMethod: URI
   externalIdentities: RGXAY_ExternalIdentityConnection_Field
   id: ID
...
class RMONE_OrganizationAuditEntryConnection_Field(OrganizationAuditEntryConnection):
   """
   RMONE_OrganizationAuditEntryConnection_Field - Audit log entries of the organization
...
class ZNKOL_VerifiableDomainConnection_Field(VerifiableDomainConnection):
   """
   ZNKOL_VerifiableDomainConnection_Field - A list of domains owned by the organization.
...
class PGPMJ_OrganizationEnterpriseOwnerConnection_Field(OrganizationEnterpriseOwnerConnection):
   """
   PGPMJ_OrganizationEnterpriseOwnerConnection_Field - A list of owners of the organization's enterprise account.
...
class HFVNI_IpAllowListEntryConnection_Field(Generic[IpAllowListEntryConnection]):
   """
   HFVNI_IpAllowListEntryConnection_Field - The IP addresses that are allowed to access resources owned by the organization.
...
class FGMIF_MannequinConnection_Field(MannequinConnection):
   """
   FGMIF_MannequinConnection_Field - A list of all mannequins for this organization.
...
class YVKUJ_UserStatusConnection_Field(UserStatusConnection):
   """
   YVKUJ_UserStatusConnection_Field - Get the status messages members of this entity have set that are either public or visible only to the organization.
...
class SHYKN_OrganizationMemberConnection_Field(OrganizationMemberConnection):
   """
   SHYKN_OrganizationMemberConnection_Field - A list of users who are members of this organization.
...
class DQUAK_PackageConnection_Field(PackageConnection):
   """
   DQUAK_PackageConnection_Field - A list of packages under the owner.
...
class HREKI_UserConnection_Field(UserConnection):
   """
   HREKI_UserConnection_Field - A list of users who have been invited to join this organization.
...
class HNFFQ_PinnableItemConnection_Field(PinnableItemConnection):
   """
   HNFFQ_PinnableItemConnection_Field - A list of repositories and gists this profile owner can pin to their profile.
...
class FGPCI_PinnableItemConnection_Field(PinnableItemConnection):
   """
   FGPCI_PinnableItemConnection_Field - A list of repositories and gists this profile owner has pinned to their profile
...
class XQIWG_Project_Field(Project):
   """
   XQIWG_Project_Field - Find project by number.
...
class UZEFA_ProjectV2_Field(ProjectV2):
   """
   UZEFA_ProjectV2_Field - Find a project by number.
...
class STLAQ_ProjectConnection_Field(ProjectConnection):
   """
   STLAQ_ProjectConnection_Field - A list of projects under the owner.
...
class OVPDJ_ProjectV2Connection_Field(ProjectV2Connection):
   """
   OVPDJ_ProjectV2Connection_Field - A list of projects under the owner.
...
class WOGHR_ProjectV2Connection_Field(ProjectV2Connection):
   """
   WOGHR_ProjectV2Connection_Field - Recent projects that this user has modified in the context of the owner.
...
class CAIJP_RepositoryConnection_Field(RepositoryConnection):
   """
   CAIJP_RepositoryConnection_Field - A list of repositories that the user owns.
...
class ZGLTO_Repository_Field(Repository):
   """
   ZGLTO_Repository_Field - Find Repository.
...
class GQZWX_DiscussionCommentConnection_Field(DiscussionCommentConnection):
   """
   GQZWX_DiscussionCommentConnection_Field - Discussion comments this user has authored.
...
class SLQKW_DiscussionConnection_Field(DiscussionConnection):
   """
   SLQKW_DiscussionConnection_Field - Discussions this user has started.
...
class BQVNI_RepositoryMigrationConnection_Field(RepositoryMigrationConnection):
   """
   BQVNI_RepositoryMigrationConnection_Field - A list of all repository migrations for this organization.
...
class HMHDF_SponsorConnection_Field(SponsorConnection):
   """
   HMHDF_SponsorConnection_Field - List of users and organizations this entity is sponsoring.
...
class RMABM_SponsorConnection_Field(SponsorConnection):
   """
   RMABM_SponsorConnection_Field - List of sponsors for this user or organization.
...
class NZYYO_SponsorsActivityConnection_Field(SponsorsActivityConnection):
   """
   NZYYO_SponsorsActivityConnection_Field - Events involving this sponsorable, such as new sponsorships.
...
class UYEWB_Sponsorship_Field(Sponsorship):
   """
   UYEWB_Sponsorship_Field - The sponsorship from the viewer to this user/organization; that is, the sponsorship where you're the sponsor.
...
class EKPZB_Sponsorship_Field(Sponsorship):
   """
   EKPZB_Sponsorship_Field - The sponsorship from this user/organization to the viewer; that is, the sponsorship you're receiving.
...
class GAMEW_SponsorshipNewsletterConnection_Field(SponsorshipNewsletterConnection):
   """
   GAMEW_SponsorshipNewsletterConnection_Field - List of sponsorship updates sent from this sponsorable to sponsors.
...
class THANJ_SponsorshipConnection_Field(SponsorshipConnection):
   """
   THANJ_SponsorshipConnection_Field - The sponsorships where this user or organization is the maintainer receiving the funds.
...
class YSGFY_SponsorshipConnection_Field(SponsorshipConnection):
   """
   YSGFY_SponsorshipConnection_Field - The sponsorships where this user or organization is the funder.
...
class WIXCH_Team_Field(Team):
   """
   WIXCH_Team_Field - Find an organization's team by its slug.
...
class IZTHJ_TeamConnection_Field(TeamConnection):
   """
   IZTHJ_TeamConnection_Field - A list of teams in this organization.
...
class Organization(GQLObject):
   ...
   announcementExpiresAt: DateTime
   announcementUserDismissible: bool
   anyPinnableItems: VMKWJ_anyPinnableItems_Field
   auditLog: RMONE_OrganizationAuditEntryConnection_Field
   avatarUrl: HBYVQ_URI_Field
   createdAt: DateTime
   databaseId: int
   description: str
   descriptionHTML: str
   domains: ZNKOL_VerifiableDomainConnection_Field
   email: str
   enterpriseOwners: PGPMJ_OrganizationEnterpriseOwnerConnection_Field
   estimatedNextSponsorsPayoutInCents: int
   hasSponsorsListing: bool
   id: ID
   interactionAbility: RepositoryInteractionAbility
   ipAllowListEnabledSetting: IpAllowListEnabledSettingValue
   ipAllowListEntries: HFVNI_IpAllowListEntryConnection_Field ## Circular Reference for IpAllowListEntryConnection
   ipAllowListForInstalledAppsEnabledSetting: IpAllowListForInstalledAppsEnabledSettingValue
   isSponsoredBy: KIYOL_isSponsoredBy_Field
   isSponsoringViewer: bool
   isVerified: bool
   itemShowcase: ProfileItemShowcase
   location: str
   login: str
   mannequins: FGMIF_MannequinConnection_Field
   memberStatuses: YVKUJ_UserStatusConnection_Field
   membersCanForkPrivateRepositories: bool
   membersWithRole: SHYKN_OrganizationMemberConnection_Field
   monthlyEstimatedSponsorsIncomeInCents: int
   name: str
   newTeamResourcePath: URI
   newTeamUrl: URI
   ...
   packages: DQUAK_PackageConnection_Field
   pendingMembers: HREKI_UserConnection_Field
   pinnableItems: HNFFQ_PinnableItemConnection_Field
   pinnedItems: FGPCI_PinnableItemConnection_Field
   pinnedItemsRemaining: int
   project: XQIWG_Project_Field
   projectV2: UZEFA_ProjectV2_Field
   projects: STLAQ_ProjectConnection_Field
   projectsResourcePath: URI
   projectsUrl: URI
   projectsV2: OVPDJ_ProjectV2Connection_Field
   recentProjects: WOGHR_ProjectV2Connection_Field
   repositories: CAIJP_RepositoryConnection_Field
   repository: ZGLTO_Repository_Field
   repositoryDiscussionComments: GQZWX_DiscussionCommentConnection_Field
   repositoryDiscussions: SLQKW_DiscussionConnection_Field
   repositoryMigrations: BQVNI_RepositoryMigrationConnection_Field
   requiresTwoFactorAuthentication: bool
   resourcePath: URI
   samlIdentityProvider: OrganizationIdentityProvider
   sponsoring: HMHDF_SponsorConnection_Field
   sponsors: RMABM_SponsorConnection_Field
   sponsorsActivities: NZYYO_SponsorsActivityConnection_Field
   sponsorsListing: SponsorsListing
   sponsorshipForViewerAsSponsor: UYEWB_Sponsorship_Field
   sponsorshipForViewerAsSponsorable: EKPZB_Sponsorship_Field
   sponsorshipNewsletters: GAMEW_SponsorshipNewsletterConnection_Field
   sponsorshipsAsMaintainer: THANJ_SponsorshipConnection_Field
   sponsorshipsAsSponsor: YSGFY_SponsorshipConnection_Field
   team: WIXCH_Team_Field
   teams: IZTHJ_TeamConnection_Field
   teamsResourcePath: URI
   teamsUrl: URI
   totalSponsorshipAmountAsSponsorInCents: NZMVG_totalSponsorshipAmountAsSponsorInCents_Field
   twitterUsername: str
   updatedAt: DateTime
   url: URI
   viewerCanAdminister: bool
...
class NOIXH_EnterpriseOrganizationMembershipConnection_Field(EnterpriseOrganizationMembershipConnection):
   """
   NOIXH_EnterpriseOrganizationMembershipConnection_Field - A list of enterprise organizations this user is a member of.
...
class EnterpriseUserAccount(GQLObject):
   ...
   """
   avatarUrl: IFUMS_URI_Field
   createdAt: DateTime
   enterprise: NewType('Enterprise', GQLObject) ## Circular Reference for Enterprise
   id: ID
   login: str
   name: str
   organizations: NOIXH_EnterpriseOrganizationMembershipConnection_Field
   resourcePath: URI
   updatedAt: DateTime
   url: URI
   user: User
...
class WGKXY_EnterpriseServerUserAccountEmailConnection_Field(EnterpriseServerUserAccountEmailConnection):
   """
   WGKXY_EnterpriseServerUserAccountEmailConnection_Field - User emails belonging to this user account.
...
class EnterpriseServerUserAccount(GQLObject):
   ...
   """
   createdAt: DateTime
   emails: WGKXY_EnterpriseServerUserAccountEmailConnection_Field
...
class UHCIQ_EnterpriseServerUserAccountConnection_Field(EnterpriseServerUserAccountConnection):
   """
   UHCIQ_EnterpriseServerUserAccountConnection_Field - User accounts on this Enterprise Server installation.
...
class JCPUO_EnterpriseServerUserAccountsUploadConnection_Field(EnterpriseServerUserAccountsUploadConnection):
   """
   JCPUO_EnterpriseServerUserAccountsUploadConnection_Field - User accounts uploads for the Enterprise Server installation.
...
class EnterpriseServerInstallation(GQLObject):
   ...
   isConnected: bool
   updatedAt: DateTime
   userAccounts: UHCIQ_EnterpriseServerUserAccountConnection_Field
   userAccountsUploads: JCPUO_EnterpriseServerUserAccountsUploadConnection_Field
...
class BDHPA_ExternalIdentityConnection_Field(ExternalIdentityConnection):
   """
   BDHPA_ExternalIdentityConnection_Field - ExternalIdentities provisioned by this identity provider.
...
class OIDCProvider(GQLObject):
   ...
   """
   enterprise: NewType('Enterprise', GQLObject) ## Circular Reference for Enterprise
   externalIdentities: BDHPA_ExternalIdentityConnection_Field
   id: ID
...
class SBNTZ_EnterpriseRepositoryInfoConnection_Field(EnterpriseRepositoryInfoConnection):
   """
   SBNTZ_EnterpriseRepositoryInfoConnection_Field - The enterprise organization repositories this user is a member of.
...
class EnterpriseOutsideCollaboratorEdge(GQLObject):
   ...
   cursor: str
   node: User
   repositories: SBNTZ_EnterpriseRepositoryInfoConnection_Field
...
class RepositoryInfo(GQLObject):
   ...
   pushedAt: DateTime
   resourcePath: URI
   shortDescriptionHTML: VUBLQ_HTML_Field
   updatedAt: DateTime
   url: URI
   usesCustomOpenGraphImage: bool
   visibility: RepositoryVisibility
...
class HVVTZ_ExternalIdentityConnection_Field(ExternalIdentityConnection):
   """
   HVVTZ_ExternalIdentityConnection_Field - ExternalIdentities provisioned by this identity provider.
...
class EnterpriseIdentityProvider(GQLObject):
   ...
   digestMethod: SamlDigestAlgorithm
   enterprise: NewType('Enterprise', GQLObject) ## Circular Reference for Enterprise
   externalIdentities: HVVTZ_ExternalIdentityConnection_Field
   id: ID
   idpCertificate: X509Certificate
   issuer: str
...
class EBSUA_EnterpriseAdministratorConnection_Field(EnterpriseAdministratorConnection):
   """
   EBSUA_EnterpriseAdministratorConnection_Field - A list of all of the administrators for this enterprise.
...
class CUAMB_UserConnection_Field(UserConnection):
   """
   CUAMB_UserConnection_Field - A list of users in the enterprise who currently have two-factor authentication disabled.
...
class HUPWL_OrganizationConnection_Field(OrganizationConnection):
   """
   HUPWL_OrganizationConnection_Field - A list of enterprise organizations configured with the provided private repository forking setting value.
...
class ETNFP_OrganizationConnection_Field(OrganizationConnection):
   """
   ETNFP_OrganizationConnection_Field - A list of enterprise organizations configured with the provided base repository permission.
...
class RWJOY_VerifiableDomainConnection_Field(VerifiableDomainConnection):
   """
   RWJOY_VerifiableDomainConnection_Field - A list of domains owned by the enterprise.
...
class QIAWL_EnterpriseServerInstallationConnection_Field(EnterpriseServerInstallationConnection):
   """
   QIAWL_EnterpriseServerInstallationConnection_Field - Enterprise Server installations owned by the enterprise.
...
class IHLZH_EnterpriseFailedInvitationConnection_Field(EnterpriseFailedInvitationConnection):
   """
   IHLZH_EnterpriseFailedInvitationConnection_Field - A list of failed invitations in the enterprise.
...
class VTBXQ_IpAllowListEntryConnection_Field(Generic[IpAllowListEntryConnection]):
   """
   VTBXQ_IpAllowListEntryConnection_Field - The IP addresses that are allowed to access resources owned by the enterprise.
...
class XORFH_OrganizationConnection_Field(OrganizationConnection):
   """
   XORFH_OrganizationConnection_Field - A list of enterprise organizations configured with the provided can change repository visibility setting value.
...
class AMAGZ_OrganizationConnection_Field(OrganizationConnection):
   """
   AMAGZ_OrganizationConnection_Field - A list of enterprise organizations configured with the provided repository creation setting value.
...
class MPDAU_OrganizationConnection_Field(OrganizationConnection):
   """
   MPDAU_OrganizationConnection_Field - A list of enterprise organizations configured with the provided members can delete issues setting value.
...
class XAQWT_OrganizationConnection_Field(OrganizationConnection):
   """
   XAQWT_OrganizationConnection_Field - A list of enterprise organizations configured with the provided members can delete repositories setting value.
...
class IXLJP_OrganizationConnection_Field(OrganizationConnection):
   """
   IXLJP_OrganizationConnection_Field - A list of enterprise organizations configured with the provided members can invite collaborators setting value.
...
class KYTMH_OrganizationConnection_Field(OrganizationConnection):
   """
   KYTMH_OrganizationConnection_Field - A list of enterprise organizations configured with the provided members can update protected branches setting value.
...
class DKHJE_OrganizationConnection_Field(OrganizationConnection):
   """
   DKHJE_OrganizationConnection_Field - A list of enterprise organizations configured with the provided members can view dependency insights setting value.
...
class JAKEM_OrganizationConnection_Field(OrganizationConnection):
   """
   JAKEM_OrganizationConnection_Field - A list of enterprise organizations configured with the provided organization projects setting value.
...
class EEPKE_EnterpriseOutsideCollaboratorConnection_Field(EnterpriseOutsideCollaboratorConnection):
   """
   EEPKE_EnterpriseOutsideCollaboratorConnection_Field - A list of outside collaborators across the repositories in the enterprise.
...
class QDLYB_EnterpriseAdministratorInvitationConnection_Field(EnterpriseAdministratorInvitationConnection):
   """
   QDLYB_EnterpriseAdministratorInvitationConnection_Field - A list of pending administrator invitations for the enterprise.
...
class IRTWE_RepositoryInvitationConnection_Field(RepositoryInvitationConnection):
   """
   IRTWE_RepositoryInvitationConnection_Field - A list of pending collaborator invitations across the repositories in the enterprise.
...
class TGMLE_EnterprisePendingMemberInvitationConnection_Field(EnterprisePendingMemberInvitationConnection):
   """
   TGMLE_EnterprisePendingMemberInvitationConnection_Field - A list of pending member invitations for organizations in the enterprise.
...
class XNZAY_OrganizationConnection_Field(OrganizationConnection):
   """
   XNZAY_OrganizationConnection_Field - A list of enterprise organizations configured with the provided repository projects setting value.
...
class PSEKV_OrganizationConnection_Field(OrganizationConnection):
   """
   PSEKV_OrganizationConnection_Field - A list of enterprise organizations configured with the SAML single sign-on setting value.
...
class OSXYS_EnterpriseMemberConnection_Field(EnterpriseMemberConnection):
   """
   OSXYS_EnterpriseMemberConnection_Field - A list of members with a support entitlement.
...
class QAINM_OrganizationConnection_Field(OrganizationConnection):
   """
   QAINM_OrganizationConnection_Field - A list of enterprise organizations configured with the provided team discussions setting value.
...
class FAGQQ_OrganizationConnection_Field(OrganizationConnection):
   """
   FAGQQ_OrganizationConnection_Field - A list of enterprise organizations configured with the two-factor authentication setting value.
...
class EnterpriseOwnerInfo(GQLObject):
   ...
   """
   admins: EBSUA_EnterpriseAdministratorConnection_Field
   affiliatedUsersWithTwoFactorDisabled: CUAMB_UserConnection_Field
   affiliatedUsersWithTwoFactorDisabledExist: bool
   allowPrivateRepositoryForkingSetting: EnterpriseEnabledDisabledSettingValue
   allowPrivateRepositoryForkingSettingOrganizations: HUPWL_OrganizationConnection_Field
   allowPrivateRepositoryForkingSettingPolicyValue: EnterpriseAllowPrivateRepositoryForkingPolicyValue
   defaultRepositoryPermissionSetting: EnterpriseDefaultRepositoryPermissionSettingValue
   defaultRepositoryPermissionSettingOrganizations: ETNFP_OrganizationConnection_Field
   domains: RWJOY_VerifiableDomainConnection_Field
   enterpriseServerInstallations: QIAWL_EnterpriseServerInstallationConnection_Field
   failedInvitations: IHLZH_EnterpriseFailedInvitationConnection_Field
   ipAllowListEnabledSetting: IpAllowListEnabledSettingValue
   ipAllowListEntries: VTBXQ_IpAllowListEntryConnection_Field ## Circular Reference for IpAllowListEntryConnection
   ipAllowListForInstalledAppsEnabledSetting: IpAllowListForInstalledAppsEnabledSettingValue
   isUpdatingDefaultRepositoryPermission: bool
   isUpdatingTwoFactorRequirement: bool
   membersCanChangeRepositoryVisibilitySetting: EnterpriseEnabledDisabledSettingValue
   membersCanChangeRepositoryVisibilitySettingOrganizations: XORFH_OrganizationConnection_Field
   ...
   membersCanCreateRepositoriesSettingOrganizations: AMAGZ_OrganizationConnection_Field
   membersCanDeleteIssuesSetting: EnterpriseEnabledDisabledSettingValue
   membersCanDeleteIssuesSettingOrganizations: MPDAU_OrganizationConnection_Field
   membersCanDeleteRepositoriesSetting: EnterpriseEnabledDisabledSettingValue
   membersCanDeleteRepositoriesSettingOrganizations: XAQWT_OrganizationConnection_Field
   membersCanInviteCollaboratorsSetting: EnterpriseEnabledDisabledSettingValue
   membersCanInviteCollaboratorsSettingOrganizations: IXLJP_OrganizationConnection_Field
   membersCanMakePurchasesSetting: EnterpriseMembersCanMakePurchasesSettingValue
   membersCanUpdateProtectedBranchesSetting: EnterpriseEnabledDisabledSettingValue
   membersCanUpdateProtectedBranchesSettingOrganizations: KYTMH_OrganizationConnection_Field
   membersCanViewDependencyInsightsSetting: EnterpriseEnabledDisabledSettingValue
   membersCanViewDependencyInsightsSettingOrganizations: DKHJE_OrganizationConnection_Field
   notificationDeliveryRestrictionEnabledSetting: NotificationRestrictionSettingValue
   oidcProvider: OIDCProvider
   organizationProjectsSetting: EnterpriseEnabledDisabledSettingValue
   organizationProjectsSettingOrganizations: JAKEM_OrganizationConnection_Field
   outsideCollaborators: EEPKE_EnterpriseOutsideCollaboratorConnection_Field
   pendingAdminInvitations: QDLYB_EnterpriseAdministratorInvitationConnection_Field
   pendingCollaboratorInvitations: IRTWE_RepositoryInvitationConnection_Field
   pendingMemberInvitations: TGMLE_EnterprisePendingMemberInvitationConnection_Field
   repositoryProjectsSetting: EnterpriseEnabledDisabledSettingValue
   repositoryProjectsSettingOrganizations: XNZAY_OrganizationConnection_Field
   samlIdentityProvider: EnterpriseIdentityProvider
   samlIdentityProviderSettingOrganizations: PSEKV_OrganizationConnection_Field
   supportEntitlements: OSXYS_EnterpriseMemberConnection_Field
   teamDiscussionsSetting: EnterpriseEnabledDisabledSettingValue
   teamDiscussionsSettingOrganizations: QAINM_OrganizationConnection_Field
   twoFactorRequiredSetting: EnterpriseEnabledSettingValue
   twoFactorRequiredSettingOrganizations: FAGQQ_OrganizationConnection_Field

class IPAAJ_EnterpriseMemberConnection_Field(EnterpriseMemberConnection):
   """
   IPAAJ_EnterpriseMemberConnection_Field - A list of users who are members of this enterprise.
...
class KJDBW_OrganizationConnection_Field(OrganizationConnection):
   """
   KJDBW_OrganizationConnection_Field - A list of organizations that belong to this enterprise.
...
class Enterprise(GQLObject):
   ...
   id: ID
   location: str
   members: IPAAJ_EnterpriseMemberConnection_Field
   name: str
   organizations: KJDBW_OrganizationConnection_Field
...
class GRYEE_IpAllowListEntryConnection_Field(IpAllowListEntryConnection):
   """
   GRYEE_IpAllowListEntryConnection_Field - The IP addresses of the app.
...
class App(GQLObject):
   ...
   description: str
   id: ID
   ipAllowListEntries: GRYEE_IpAllowListEntryConnection_Field
   logoBackgroundColor: str
   logoUrl: XTPZA_URI_Field
   name: str
   slug: str
   updatedAt: DateTime
   url: URI
...
class AATKS_CheckRunConnection_Field(CheckRunConnection):
   """
   AATKS_CheckRunConnection_Field - The check runs associated with a check suite.
...
class BLIKZ_PullRequestConnection_Field(PullRequestConnection):
   """
   BLIKZ_PullRequestConnection_Field - A list of open pull requests matching the check suite.
...
class CheckSuite(GQLObject):
   ...
   app: App
   branch: Ref
   checkRuns: AATKS_CheckRunConnection_Field
   commit: Commit
   conclusion: CheckConclusionState
   createdAt: DateTime
   creator: User
   databaseId: int
   id: ID
   matchingPullRequests: BLIKZ_PullRequestConnection_Field
   push: Push
   repository: Repository
   resourcePath: URI
   status: CheckStatusState
...
class POKAO_EnvironmentConnection_Field(EnvironmentConnection):
   """
   POKAO_EnvironmentConnection_Field - The environments approved or rejected
...
class DeploymentReview(GQLObject):
   ...
   comment: str
   databaseId: int
   environments: POKAO_EnvironmentConnection_Field
   id: ID
...
class KBJKO_WorkflowRunConnection_Field(Generic[WorkflowRunConnection]):
   """
   KBJKO_WorkflowRunConnection_Field - The runs of the workflow.
...
class Workflow(GQLObject):
   ...
   id: ID
   name: str
   runs: KBJKO_WorkflowRunConnection_Field ## Circular Reference for WorkflowRunConnection
   updatedAt: DateTime

class ABPBO_DeploymentReviewConnection_Field(DeploymentReviewConnection):
   """
   ABPBO_DeploymentReviewConnection_Field - The log of deployment reviews
...
class AVIVZ_DeploymentRequestConnection_Field(DeploymentRequestConnection):
   """
   AVIVZ_DeploymentRequestConnection_Field - The pending deployment requests of all check runs in this workflow run
...
class WorkflowRun(GQLObject):
   ...
   createdAt: DateTime
   databaseId: int
   deploymentReviews: ABPBO_DeploymentReviewConnection_Field
   id: ID
   pendingDeploymentRequests: AVIVZ_DeploymentRequestConnection_Field
   resourcePath: URI
   runNumber: int
   updatedAt: DateTime
   url: URI
...
class FCUHD_PullRequestReviewCommentConnection_Field(PullRequestReviewCommentConnection):
   """
   FCUHD_PullRequestReviewCommentConnection_Field - A list of pull request comments associated with the thread.
...
class PullRequestThread(GQLObject):
   ...
   """
   comments: FCUHD_PullRequestReviewCommentConnection_Field
   diffSide: DiffSide
   id: ID
   isCollapsed: bool
   isOutdated: bool
...
class AXQFO_PinnableItemConnection_Field(PinnableItemConnection):
   """
   AXQFO_PinnableItemConnection_Field - A list of repositories and gists this profile owner can pin to their profile.
...
class EOJOF_PinnableItemConnection_Field(PinnableItemConnection):
   """
   EOJOF_PinnableItemConnection_Field - A list of repositories and gists this profile owner has pinned to their profile
...
class ProfileOwner(GQLObject):
   ...
   """
   anyPinnableItems: ODBXR_anyPinnableItems_Field
   email: str
   id: ID
   itemShowcase: ProfileItemShowcase
   location: str
   login: str
   name: str
   pinnableItems: AXQFO_PinnableItemConnection_Field
   pinnedItems: EOJOF_PinnableItemConnection_Field
   pinnedItemsRemaining: int
   viewerCanChangePinnedItems: bool
   websiteUrl: URI
...
class CSDUY_UserContentEditConnection_Field(UserContentEditConnection):
   """
   CSDUY_UserContentEditConnection_Field - A list of edits to this content.
...
class Comment(GQLObject):
   ...
   publishedAt: DateTime
   updatedAt: DateTime
   userContentEdits: CSDUY_UserContentEditConnection_Field
   viewerDidAuthor: bool
...
class MOAOP_StargazerConnection_Field(StargazerConnection):
   """
   MOAOP_StargazerConnection_Field - A list of users who have starred this starrable.
...
class Starrable(GQLObject):
   ...
   id: ID
   stargazerCount: int
   stargazers: MOAOP_StargazerConnection_Field
   viewerHasStarred: bool
...
class JXQEL_OrganizationConnection_Field(OrganizationConnection):
   """
   JXQEL_OrganizationConnection_Field - The organizations that had the migrator role applied to for the given user.
...
class GrantEnterpriseOrganizationsMigratorRolePayload(GQLObject):
   ...
   """
   clientMutationId: str
   organizations: JXQEL_OrganizationConnection_Field
...
class ROTHT_UserStatusConnection_Field(UserStatusConnection):
   """
   ROTHT_UserStatusConnection_Field - Get the status messages members of this entity have set that are either public or visible only to the organization.
...
class MemberStatusable(GQLObject):
   ...
   """
   memberStatuses: ROTHT_UserStatusConnection_Field
...
class WPSXU_TeamConnection_Field(TeamConnection):
   """
   WPSXU_TeamConnection_Field - Teams in this organization the user is a member of that are relevant
...
class OrganizationTeamsHovercardContext(GQLObject):
   ...
   message: str
   octicon: str
   relevantTeams: WPSXU_TeamConnection_Field
   teamsResourcePath: URI
   teamsUrl: URI
   totalTeamCount: int

class VEVKT_OrganizationConnection_Field(OrganizationConnection):
   """
   VEVKT_OrganizationConnection_Field - Organizations this user is a member of that are relevant
...
class OrganizationsHovercardContext(GQLObject):
   ...
   message: str
   octicon: str
   relevantOrganizations: VEVKT_OrganizationConnection_Field
   totalOrganizationCount: int

class ERDRS_PackageConnection_Field(PackageConnection):
   """
   ERDRS_PackageConnection_Field - A list of packages under the owner.
...
class PackageOwner(GQLObject):
   ...
   """
   id: ID
   packages: ERDRS_PackageConnection_Field
...
class PBWAB_ProjectV2Connection_Field(ProjectV2Connection):
   """
   PBWAB_ProjectV2Connection_Field - Recent projects that this user has modified in the context of the owner.
...
class ProjectV2Recent(GQLObject):
   ...
   """
   recentProjects: PBWAB_ProjectV2Connection_Field
...
class CKMDM_DiscussionConnection_Field(DiscussionConnection):
   """
   CKMDM_DiscussionConnection_Field - Discussions this user has started.
...
class RepositoryDiscussionAuthor(GQLObject):
   ...
   """
   repositoryDiscussions: CKMDM_DiscussionConnection_Field

class RRQNO_DiscussionCommentConnection_Field(DiscussionCommentConnection):
   """
   RRQNO_DiscussionCommentConnection_Field - Discussion comments this user has authored.
...
class RepositoryDiscussionCommentAuthor(GQLObject):
   ...
   """
   repositoryDiscussionComments: RRQNO_DiscussionCommentConnection_Field
...
class KIAPH_OrganizationConnection_Field(OrganizationConnection):
   """
   KIAPH_OrganizationConnection_Field - The organizations that had the migrator role revoked for the given user.
...
class RevokeEnterpriseOrganizationsMigratorRolePayload(GQLObject):
   ...
   """
   clientMutationId: str
   organizations: KIAPH_OrganizationConnection_Field
...
class NMZEA_ProjectV2ItemConnection_Field(ProjectV2ItemConnection):
   """
   NMZEA_ProjectV2ItemConnection_Field - The items in the new order
...
class UpdateProjectV2ItemPositionPayload(GQLObject):
   ...
   """
   clientMutationId: str
   items: NMZEA_ProjectV2ItemConnection_Field
