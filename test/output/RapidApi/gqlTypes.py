...
class RequestLogFilters(GQLObject):
   ...
   userIds: list[ID] ##NON NULL
   endpoints: list[str] ##NON NULL
   endpointRoutes: list[str] ##NON NULL
   httpMethods: list[HttpMethod] ##NON NULL
   httpStatuses: list[int] ##NON NULL
   originIps: list[str] ##NON NULL
   gatewayIds: list[ID]
...
class deleteProjectAllowedAPIsInput(GQLObject):
   projectAllowedAPIIds: list[int] ##NON NULL
...
class ThreadEntityStatusUpdateInput(GQLObject):
   messageThreadIds: list[int] ##NON NULL
...
class ConsumersWhereInput(GQLObject):
   ...
   limit: int
   order: str
   lastActive: list[str] ##NON NULL
   userId: list[int] ##NON NULL
   sort: str
   usernames: list[str] ##NON NULL
   plansFilter: list[str] ##NON NULL
...
class ApiWhereInput(GQLObject):
   ...
   """
   id: list[ID] ##NON NULL
   ownerId: list[ID] ##NON NULL
   subscriberId: list[ID] ##NON NULL
   visibility: ApiVisibility
   apiSlugifiedName: list[str] ##NON NULL
   ownerSlugifiedName: list[str] ##NON NULL
   name: list[str] ##NON NULL
   isFavorite: bool
...
class Endpoint(GQLObject):
   ...
   displayResponse: bool
   isGraphQL: bool
   graphQLSchema: GraphQLSchemaField
   mockResponseId: ID
   isMockResponse: bool
   summary: str
   ...
   mockResponse: ResponsePayloadField
...
class BillingItem(GQLObject):
   ...
   createdAt: DateTime
   updatedAt: DateTime
   billingitemendpoints: list[BillingItemEndpointField]
   allEndpoints: bool
   usageInSubscription: list[UsageDataField]
...
class BillingSubscription(GQLObject):
   ...
   user: NewType('User', GQLObject) ## Circular Reference for User
   billingPlanVersion: NewType('BillingPlanVersion', GQLObject) ## Circular Reference for BillingPlanVersion
   usageByBillingItem: list[UsagePeriodGrouperField]
...
class BillingPlanVersion(GQLObject):
   ...
   createdAt: DateTime
   updatedAt: DateTime
   apiVersionBillingPlanVersion: list[ApiVersionBillingPlanVersionField]
   billinglimits: list[BillingLimitField]
...
class BillingPlan(GQLObject):
   ...
   legalAccountId: str
   isStudent: bool
   version: BillingPlanVersionField
...
class ApiVersion(GQLObject):
   ...
   webhooks: bool
   payloads: list[ResponsePayloadField]
   accessControl: ApiVersionAccessControlInfo ##NON NULL
   endpoints: list[EndpointField]
   groups: list[EndpointsGroupField]
   publicdns: list[PublicdnsField]
   billingplans: list[BillingPlanField]
   headlines: list[HeadlineField]
   billingitems: list[BillingItemField]
   billingitemendpoints: list[BillingItemEndpointField]
...
class RequestLogsResultField(RequestLogsResult):
   """
...
class Api(GQLObject):
   ...
   announcements: list[AnnouncementField]
   apiDevelopers: list[ApiDeveloperField]
   ...
   headlines: list[HeadlineField]
   endpoints: list[EndpointField]
   billingFeatures: list[BillingFeatureField]
   billingItems: list[BillingItemField]
   billingPlans: list[BillingPlanField]
   isFavorite: bool ##NON NULL
   quality: ApiQuality ##NON NULL
   requestLogs: RequestLogsResultField
...
class Project(GQLObject):
   ...
   projectAllowedAPIs: list[ProjectAllowedAPIField]
   requestLogs: RequestLogsResultField
...
class Entity(GQLObject):
   ...
   subscriptions: list[BillingSubscriptionField]
   subscriptionsPaging: SubscriptionsPagingField
   activeSubscriptionByApiId: list[BillingSubscriptionField]
   activeSubscriptionByApiIdAndBillingPlanVersionId: list[BillingSubscriptionField]
   pagedTransactions: TransactionsPagingField
   notFullyRefundedTransactions: TransactionsPagingField
   transactionsGraphData: TransactionsGraphData
   transaction: TransactionField
   parents: list[NewType('Entity', GQLObject)] ## Circular Reference for Entity
   stats: list[StatsField]
...
class Team(GQLObject):
   ...
   description: str
   subscriptions: list[BillingSubscriptionField]
   followersList: list[FollowersUserField]
   publishedApisList: list[Api]
   isTeamMember: bool
   issues: IssueObjectField
...
class User(GQLObject):
   ...
   apisCount: int
   followersList: list[FollowersUserField]
   followsList: list[FollowUserField]
...
class BillingPlanCreateInput(GQLObject):
   ...
   rateLimit: RateLimitInput
   enableBillingFeatures: list[EnableBillingFeatureInput]
   billingLimits: list[BillingLimitInput] ##NON NULL
...
class ApiVersionAccessControlUpdateInput(GQLObject):
   secretParameters: list[ApiVersionSecretParameterInput] ##NON NULL
...
class ApiVersionUpdateInput(GQLObject):
   ...
   associatedCertificates: list[ApiCertificateAssociationTarget] ##NON NULL
...
class GatewayInstanceUpdateInput(GQLObject):
   ...
   customMessages: list[GatewayCustomMessageUpdateInput] ##NON NULL
   isDefault: bool
...
class GatewayInstanceCreateInput(GQLObject):
   ...
   customMessages: list[GatewayCustomMessageCreateInput] ##NON NULL
   isDefault: bool
...
class EventUrlSortablesInput(GQLObject):
   sortingFields: list[EventUrlSortablesSortingField] ##NON NULL

class GatewayInstanceSortingInput(GQLObject):
   sortingFields: list[GatewayInstanceSortingSortingField] ##NON NULL

class GatewayTemplateSortingInput(GQLObject):
   sortingFields: list[GatewayTemplateSortingSortingField] ##NON NULL

class GatewayTemplateParamSortingInput(GQLObject):
   sortingFields: list[GatewayTemplateParamsSortingFieldNameSortingField] ##NON NULL

class AdminAuditLogSortablesInput(GQLObject):
   sortingFields: list[AdminAuditLogSortablesSortingField] ##NON NULL

class EventLogSortablesInput(GQLObject):
   sortingFields: list[EventLogSortablesSortingField] ##NON NULL

class GatewayTemplateCreateInput(GQLObject):
   name: str ##NON NULL
   description: str ##NON NULL
   urlPattern: str ##NON NULL
   headers: list[PartialGatewayTemplateParamCreateInput] ##NON NULL
...
class GatewayTemplateUpdateInput(GQLObject):
   ...
   urlPattern: str ##NON NULL
   id: ID ##NON NULL
   headers: list[GatewayTemplateParamsUpdateInput] ##NON NULL
...
class ApiCertificateOrderByInput(GQLObject):
   sortingFields: list[ApiCertificateSortingField] ##NON NULL
...
class SaveApiDevelopersInput(GQLObject):
   apiId: ID ##NON NULL
   developers: list[ApiDeveloperInput] ##NON NULL

class ApiFollowerOrderByInput(GQLObject):
   fields: list[ApiFollowerSortingField] ##NON NULL
...
class ApiVersionOrderByInput(GQLObject):
   sortingFields: list[ApiVersionSortingField] ##NON NULL

class ApiOrderByInput(GQLObject):
   sortingFields: list[ApiSortingField] ##NON NULL
...
class CategoryCreateInput(GQLObject):
   information: list[CategoryTextualDataInput] ##NON NULL
   thumbnail: str
   pageTitle: str
   weight: int ##NON NULL
...
class CategoryOrderByInput(GQLObject):
   fields: list[CategorySortingField] ##NON NULL

class CollectionsOrderByInput(GQLObject):
   sortingFields: list[CollectionsSortingField] ##NON NULL
...
class RoleUpdateInput(GQLObject):
   ...
   isBasicRole: bool
   isDefault: bool
   permissions: list[VirtualPermissionUpdateInput] ##NON NULL

class RoleOrderByInput(GQLObject):
   sortingFields: list[RoleSorting] ##NON NULL

class SearchApiOrderByInput(GQLObject):
   sortingFields: list[SearchApiSortingField] ##NON NULL

class SearchCollectionOrderByInput(GQLObject):
   sortingFields: list[SearchCollectionSortingField] ##NON NULL

class SpotlightOrderByInput(GQLObject):
   sortingFields: list[SpotlightSortingField] ##NON NULL
...
class TargetGroupUpdateInput(GQLObject):
   ...
   targetUrls: list[TargetUrlUpdateInput] ##NON NULL
...
class TransformationOrderByInput(GQLObject):
   fields: list[TransformationSortingField] ##NON NULL

class TutorialOrderByInput(GQLObject):
   sortingFields: list[TutorialSortingField] ##NON NULL
